...
`;const o=Object.entries(S).slice(0,20);for(const[r,s]of o)n+=`• \`${r}\`: \`${s}\`
`;return n+=`
...
3. Delete \`webllm/model\``};default:return{error:!0,message:`❌ Unknown action: \`${t}\``}}}static cmdReload(){return setTimeout(()=>{window.location.reload()},500),{message:"🔄 Reloading page..."}}static cmdExport(){const e=document.getElementById("chat-messages");if(!e)return{error:!0,message:"❌ Chat canvas not found"};const n=Array.from(e.children).map(p=>({type:p.tagName.toLowerCase().includes("prompt")?"user":"assistant",message:p.getAttribute("message"),timestamp:p.getAttribute("timestamp")})),o=JSON.stringify(n,null,2),r=new Blob([o],{type:"application/json"}),s=URL.createObjectURL(r),c=document.createElement("a");return c.href=s,c.download=`chat-export-${Date.now()}.json`,c.click(),URL.revokeObjectURL(s),{message:`✅ Exported ${n.length} messages`}}static cmdTheme(e){const t=e[0]?.toLowerCase();return!t||!["dark","light"].includes(t)?{message:"🎨 **Theme Toggle**\n\nUsage: `::theme dark|light`"}:(localStorage.setItem("theme",t),{message:`🎨 Theme set to **${t}**
...
`,{message:o}}}const Ft=Object.freeze(Object.defineProperty({__proto__:null,default:Ut},Symbol.toStringTag,{value:"Module"}));function Dt(){return`
  ...
  `}function Ht(){console.log("[SigninRoute] Initialized");const a=document.getElementById("loginForm"),e=document.getElementById("email"),t=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const r=t.type==="password"?"text":"password";t.type=r}),a?.addEventListener("submit",async r=>{r.preventDefault();const s=e.value.trim(),c=t.value;Vt(s,e)&&Bt(c,t)&&await $t(s,c)}),document.getElementById("link--uc__underline")?.addEventListener("click",r=>{r.preventDefault(),i.publish(l.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",r=>{r.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),i.publish(l.ROUTE_NAV,{route:"signup"})})}function Vt(a,e){if(!a)return ee(e,_.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(ee(e,_.get("validation_email_invalid")),!1):!0}function Bt(a,e){return a?a.length<10?(ee(e,_.get("validation_password_min_length")),!1):!0:(ee(e,_.get("validation_password_required")),!1)}function ee(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function $t(a,e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent=_.get("loading_signing_in");try{const n=_e(e),o=await F.doSignin(a,n);o.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(_.get("success_welcome_back"),"success"),i.publish(l.AUTH_SIGNIN_SUCCESS,{entity:F.getEntity()})):o.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(_.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(o.error||_.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=_.get("sign_in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||_.get("error_network"),"danger"),t.disabled=!1,t.textContent=_.get("sign_in").toUpperCase(),i.publish(l.AUTH_SIGNIN_FAIL,{message:n.message})}}const qt=Object.freeze(Object.defineProperty({__proto__:null,init:Ht,render:Gt},Symbol.toStringTag,{value:"Module"}));function Ve(a){const e=[];return a.length<10&&e.push("at least 10 characters"),/[a-z]/.test(a)||e.push("1 lowercase"),/[A-Z]/.test(a)||e.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(a)||e.push("1 special character"),/[^\x00-\x7F]/.test(a)&&e.push("ASCII characters only"),e}function Be(a){return a.length===0?"":a.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":a.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}function zt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function jt(){console.log("[SignupRoute] Initialized");const a=document.getElementById("signupForm"),e=a.querySelector('button[type="submit"]');Ne("togglePassword","password","eyeIcon"),Ne("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),i.publish(l.ROUTE_NAV,{route:"signin"})}),a.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),r=document.getElementById("last").value.trim(),s=document.getElementById("email").value.trim(),c=document.getElementById("company").value.trim(),p=document.getElementById("phone").value.trim(),m=document.getElementById("password").value,E=document.getElementById("confirmPassword").value,O=document.getElementById("first"),w=document.getElementById("last"),R=document.getElementById("email"),D=document.getElementById("password"),u=document.getElementById("confirmPassword");if(Re(o,O,_.get("validation_first_name_required"))&&Re(r,w,_.get("validation_last_name_required"))&&Yt(s,R)&&Wt(m,D)){if(m!==E){B(u,_.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=_.get("loading_creating_account"),await Kt(o,r,s,c,p,m)}})}function Ne(a,e,t){const n=document.getElementById(a),o=document.getElementById(e),r=document.getElementById(t);!n||!o||!r||n.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Re(a,e,t){return a?!0:(B(e,t),!1)}function Yt(a,e){if(!a)return B(e,_.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(B(e,_.get("validation_email_invalid")),!1):!0}function Wt(a,e){if(!a)return B(e,_.get("validation_password_required")),!1;const t=Ve(a);return t.length>0?(B(e,Be(t)),!1):!0}function B(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function Kt(a,e,t,n,o,r){const s=document.querySelector('button[type="submit"]');try{const c=_e(r),p={email:t,hash:c,first:a,last:e};n&&(p.company=n),o&&(p.phone=o);const m=await F.doSignup(p);if(m.ok)i.publish(l.AUTH_SIGNUP_SUCCESS,{email:t}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const E=m.error||m.message||_.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(E,"danger"),s.disabled=!1,s.textContent=_.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:E})}}catch(c){console.error("[SignupRoute] Sign up error:",c),typeof neodigmToast<"u"&&neodigmToast.q(c.message||_.get("error_network"),"danger"),s.disabled=!1,s.textContent=_.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:c.message})}}const Jt=Object.freeze(Object.defineProperty({__proto__:null,init:jt,render:zt},Symbol.toStringTag,{value:"Module"}));function Qt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function on(){console.log("[ForgotRoute] Initialized");const a=document.getElementById("forgot-form"),e=document.getElementById("email");a?.addEventListener("submit",async t=>{t.preventDefault();const n=e.value.trim();rn(n,e)&&await sn(n)})}function rn(a,e){if(!a)return Ie(e,_.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(Ie(e,_.get("validation_email_invalid")),!1):!0}function Ie(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function sn(a){const e=document.querySelector(".btn");e.disabled=!0,e.textContent="SENDING...";try{const t=await nn.forgotPassword(a);t.ok&&t.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(_.get("success_reset_link_sent"),"success"),i.publish(l.AUTH_FORGOT_SUCCESS,{email:a}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(t.data.error||_.get("error_signin_failed"),"danger"),e.disabled=!1,e.textContent=_.get("send_reset_link").toUpperCase())}catch(t){console.error("[ForgotRoute] Forgot password error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||_.get("error_network"),"danger"),e.disabled=!1,e.textContent=_.get("send_reset_link").toUpperCase()}}const ln=Object.freeze(Object.defineProperty({__proto__:null,init:on,render:an},Symbol.toStringTag,{value:"Module"}));function cn(){return`
    <div class="auth-container">
      <div class="auth-left">

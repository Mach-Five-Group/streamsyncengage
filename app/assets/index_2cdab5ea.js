...
`,{message:o}}}const Ft=Object.freeze(Object.defineProperty({__proto__:null,default:Ut},Symbol.toStringTag,{value:"Module"}));function xt(){return`
  ...
  `}function Dt(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const a=localStorage.getItem(S.FF_SSE_LS_TOKEN),e=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!a,hasMvvTs:!!e});const t=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");a?(console.log("[SplashRoute] Auth token found → HOME"),i.publish(l.ROUTE_NAV,{route:"home"})):e?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),i.publish(l.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),t&&(t.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),i.publish(l.ROUTE_NAV,{route:r})})}))},4e3)}const He=Object.freeze(Object.defineProperty({__proto__:null,init:Dt,render:xt},Symbol.toStringTag,{value:"Module"}));function _e(a){return a=String(a),Math.abs(a.split("").reduce((e,t)=>(e<<5)-e+t.charCodeAt(0)|0,0))}function Gt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Ht(){console.log("[SigninRoute] Initialized");const a=document.getElementById("loginForm"),e=document.getElementById("email"),t=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const s=t.type==="password"?"text":"password";t.type=s}),a?.addEventListener("submit",async s=>{s.preventDefault();const r=e.value.trim(),c=t.value;Vt(r,e)&&Bt(c,t)&&await $t(r,c)}),document.getElementById("link--uc__underline")?.addEventListener("click",s=>{s.preventDefault(),i.publish(l.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",s=>{s.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),i.publish(l.ROUTE_NAV,{route:"signup"})})}function Vt(a,e){if(!a)return ee(e,_.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(ee(e,_.get("validation_email_invalid")),!1):!0}function Bt(a,e){return a?a.length<10?(ee(e,_.get("validation_password_min_length")),!1):!0:(ee(e,_.get("validation_password_required")),!1)}function ee(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function $t(a,e){const t=document.querySelector(".btn"),n=t.textContent;t.removeAttribute("data-meta-copywrite-i118n"),t.disabled=!0,t.textContent=_.get("loading_signing_in");try{const o=_e(e),s=await F.doSignin(a,o);s.ok?(console.log("[SigninRoute] Signin successful"),t.textContent="✓ Success",typeof neodigmToast<"u"&&neodigmToast.q(_.get("success_welcome_back"),"success"),i.publish(l.AUTH_SIGNIN_SUCCESS,{entity:F.getEntity()})):s.resetRequired?(console.log("[SigninRoute] Password reset required"),t.textContent="Password Reset Required",typeof neodigmToast<"u"&&neodigmToast.q(_.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(s.error||_.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=n,t.setAttribute("data-meta-copywrite-i118n",'{"token": "sign_in", "attribute": "textContent"}'))}catch(o){console.error("[SigninRoute] Sign in error:",o),typeof neodigmToast<"u"&&neodigmToast.q(o.message||_.get("error_network"),"danger"),t.disabled=!1,t.textContent=n,t.setAttribute("data-meta-copywrite-i118n",'{"token": "sign_in", "attribute": "textContent"}'),i.publish(l.AUTH_SIGNIN_FAIL,{message:o.message})}}const qt=Object.freeze(Object.defineProperty({__proto__:null,init:Ht,render:Gt},Symbol.toStringTag,{value:"Module"}));function Ve(a){const e=[];return a.length<10&&e.push("at least 10 characters"),/[a-z]/.test(a)||e.push("1 lowercase"),/[A-Z]/.test(a)||e.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(a)||e.push("1 special character"),/[^\x00-\x7F]/.test(a)&&e.push("ASCII characters only"),e}function Be(a){return a.length===0?"":a.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":a.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}function zt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function jt(){console.log("[SignupRoute] Initialized");const a=document.getElementById("signupForm"),e=a.querySelector('button[type="submit"]');Ne("togglePassword","password","eyeIcon"),Ne("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),i.publish(l.ROUTE_NAV,{route:"signin"})}),a.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),c=document.getElementById("company").value.trim(),p=document.getElementById("phone").value.trim(),h=document.getElementById("password").value,E=document.getElementById("confirmPassword").value,L=document.getElementById("first"),w=document.getElementById("last"),R=document.getElementById("email"),x=document.getElementById("password"),u=document.getElementById("confirmPassword");if(Re(o,L,_.get("validation_first_name_required"))&&Re(s,w,_.get("validation_last_name_required"))&&Yt(r,R)&&Wt(h,x)){if(h!==E){B(u,_.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=_.get("loading_creating_account"),await Kt(o,s,r,c,p,h)}})}function Ne(a,e,t){const n=document.getElementById(a),o=document.getElementById(e),s=document.getElementById(t);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Re(a,e,t){return a?!0:(B(e,t),!1)}function Yt(a,e){if(!a)return B(e,_.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(B(e,_.get("validation_email_invalid")),!1):!0}function Wt(a,e){if(!a)return B(e,_.get("validation_password_required")),!1;const t=Ve(a);return t.length>0?(B(e,Be(t)),!1):!0}function B(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function Kt(a,e,t,n,o,s){const r=document.querySelector('button[type="submit"]');try{const c=_e(s),p={email:t,hash:c,first:a,last:e};n&&(p.company=n),o&&(p.phone=o);const h=await F.doSignup(p);if(h.ok)i.publish(l.AUTH_SIGNUP_SUCCESS,{email:t}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const E=h.error||h.message||_.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(E,"danger"),r.disabled=!1,r.textContent=_.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:E})}}catch(c){console.error("[SignupRoute] Sign up error:",c),typeof neodigmToast<"u"&&neodigmToast.q(c.message||_.get("error_network"),"danger"),r.disabled=!1,r.textContent=_.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:c.message})}}const Jt=Object.freeze(Object.defineProperty({__proto__:null,init:jt,render:zt},Symbol.toStringTag,{value:"Module"}));function Qt(){return`
    <div class="auth-container">
      <div class="auth-left">

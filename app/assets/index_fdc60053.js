...
`;class ia extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._built=!1}static get observedAttributes(){return["data-ether5-caption","data-ether5-title","data-ether5-desc","data-ether5-gap","selected"]}connectedCallback(){this.build(),this.paint(),this.hasAttribute("data-ether5-shape")||this.setAttribute("data-ether5-shape","SQUARE"),this.hasAttribute("role")||this.setAttribute("role","group")}attributeChangedCallback(){this._built&&this.paint()}get shape(){const t=(this.getAttribute("data-ether5-shape")||"SQUARE").toUpperCase();return ua.has(t)?t:"SQUARE"}get selected(){return this.hasAttribute("selected")}set selected(t){this.toggleAttribute("selected",!!t)}get caption(){return this.getAttribute("data-ether5-caption")||""}get title(){return this.getAttribute("data-ether5-title")||""}get desc(){return this.getAttribute("data-ether5-desc")||""}get token(){return this.getAttribute("data-ether5-token")||""}build(){this._built||(this.shadowRoot.innerHTML=`
    ...
    `,this._face=this.shadowRoot.querySelector(".face"),this._built=!0,this._face.addEventListener("click",this.handleSelect),this.shadowRoot.querySelector(".verbs").addEventListener("click",this.handleVerb))}paint(){const t=this.getAttribute("data-ether5-gap");t&&this.style.setProperty("--e5-gap",/^\d+$/.test(t)?`${t}px`:t);for(const n of this.shadowRoot.querySelectorAll(".caption"))n.textContent=this.caption;for(const n of this.shadowRoot.querySelectorAll(".title"))n.textContent=this.title;for(const n of this.shadowRoot.querySelectorAll(".desc"))n.textContent=this.desc;this.setAttribute("aria-label",[this.caption,this.title].filter(Boolean).join(" - ")||"Card")}handleSelect=t=>{t.preventDefault(),this.selected=!this.selected,this.paint(),this.emit("ether5-select",{selected:this.selected,message:this.selected&&this.getAttribute("data-ether5-prompt")||void 0})};handleVerb=t=>{const n=t.target?.closest?.("[data-ether5-verb]");n&&(t.preventDefault(),t.stopPropagation(),this.emit("ether5-verb",{verb:n.getAttribute("data-ether5-verb")}))};emit(t,n){this.dispatchEvent(new CustomEvent(t,{bubbles:!0,composed:!0,detail:{pubsubTopic:this.getAttribute("data-ether5-topic")||void 0,token:this.token,caption:this.caption,title:this.title,shape:this.shape,...n}}))}}customElements.define("ether5-card",ia);function Gt(e,t){return(Array.isArray(e?.tags)?e.tags:[]).find(r=>r?.tag===t)?.value||""}function sa(e){return e?String(e).trim().replace(/^[a-z][a-z0-9+.-]*:\/\//i,"").replace(/^[^@/]*@/,"").split(/[/?#]/)[0].replace(/:\d+$/,"").replace(/^www\./i,"").toLowerCase():""}function hr(e){const t=Array.isArray(e?.app_domains)?e.app_domains:[];return sa(t[0]?.domain)}function ca(e){return Gt(e,"app_caption")||hr(e)||"no domain"}function wn(e){return Gt(e,"app_name")||hr(e)||"Untitled app"}function la(e){const n=(Array.isArray(e?.modified)?e.modified:[]).map(r=>Date.parse(r?.modified_tz)).filter(r=>Number.isFinite(r));return n.length?new Date(Math.max(...n)).toISOString():e?.created?.created_tz||""}const da=[["year",31536e3],["month",2592e3],["week",604800],["day",86400],["hour",3600],["minute",60]];function fa(e,t=Date.now()){const n=Date.parse(e);if(!Number.isFinite(n))return"Never updated";const r=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}),o=(n-t)/1e3,u=Math.abs(o);for(const[a,i]of da)if(u>=i)return`Updated ${r.format(Math.round(o/i),a)}`;return"Updated just now"}function ha(e,t=Date.now()){const n=Gt(e,"app_desc")||fa(la(e),t),r=e?.status;return r&&r!=="ENABLED"?`${n} · ${r}`:n}const Sn=["WIDE","SQUARE","SQUARE","TALL","SQUARE","WIDE","SQUARE","WIDE"];function pa(e){return Sn[e%Sn.length]}function xn(e,t){return Array.isArray(e)?t?e.filter(n=>n?.owner_guid===t):(console.warn("[etherApps] no signed-in guid - showing every app the API returned"),e):[]}const kn=50;function Cn(){const e=window.AuthController?.getEntity?.();return e?.class?typeof e.class=="object"?e.class.value??0:Lt(e.class)?.value??0:0}ot({id:"ACCOUNT_SUMMARY",when:"the user asks about their own account, profile, role, or plan",render:()=>{const e=window.AuthController?.getEntity?.();return e?`
      <h3>Account</h3>

...
`,{message:o}}}const Ft=Object.freeze(Object.defineProperty({__proto__:null,default:Ut},Symbol.toStringTag,{value:"Module"}));function Dt(){return`
  ...
  `}function Ht(){console.log("[SigninRoute] Initialized");const a=document.getElementById("loginForm"),e=document.getElementById("email"),t=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const s=t.type==="password"?"text":"password";t.type=s}),a?.addEventListener("submit",async s=>{s.preventDefault();const r=e.value.trim(),d=t.value;Bt(r,e)&&Vt(d,t)&&await $t(r,d)}),document.getElementById("link--uc__underline")?.addEventListener("click",s=>{s.preventDefault(),i.publish(l.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",s=>{s.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),i.publish(l.ROUTE_NAV,{route:"signup"})})}function Bt(a,e){if(!a)return te(e,p.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(te(e,p.get("validation_email_invalid")),!1):!0}function Vt(a,e){return a?a.length<10?(te(e,p.get("validation_password_min_length")),!1):!0:(te(e,p.get("validation_password_required")),!1)}function te(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function $t(a,e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent=p.get("loading_signing_in");try{const n=_e(e),o=await F.doSignin(a,n);o.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(p.get("success_welcome_back"),"success"),i.publish(l.AUTH_SIGNIN_SUCCESS,{entity:F.getEntity()})):o.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(p.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(o.error||p.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=p.get("sign_in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||p.get("error_network"),"danger"),t.disabled=!1,t.textContent=p.get("sign_in").toUpperCase(),i.publish(l.AUTH_SIGNIN_FAIL,{message:n.message})}}const zt=Object.freeze(Object.defineProperty({__proto__:null,init:Ht,render:Gt},Symbol.toStringTag,{value:"Module"}));function Be(a){const e=[];return a.length<10&&e.push("at least 10 characters"),/[a-z]/.test(a)||e.push("1 lowercase"),/[A-Z]/.test(a)||e.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(a)||e.push("1 special character"),/[^\x00-\x7F]/.test(a)&&e.push("ASCII characters only"),e}function Ve(a){return a.length===0?"":a.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":a.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}function qt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function jt(){console.log("[SignupRoute] Initialized");const a=document.getElementById("signupForm"),e=a.querySelector('button[type="submit"]');Ne("togglePassword","password","eyeIcon"),Ne("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),i.publish(l.ROUTE_NAV,{route:"signin"})}),a.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),d=document.getElementById("company").value.trim(),_=document.getElementById("phone").value.trim(),h=document.getElementById("password").value,E=document.getElementById("confirmPassword").value,L=document.getElementById("first"),w=document.getElementById("last"),R=document.getElementById("email"),D=document.getElementById("password"),u=document.getElementById("confirmPassword");if(Re(o,L,p.get("validation_first_name_required"))&&Re(s,w,p.get("validation_last_name_required"))&&Yt(r,R)&&Wt(h,D)){if(h!==E){V(u,p.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=p.get("loading_creating_account"),await Kt(o,s,r,d,_,h)}})}function Ne(a,e,t){const n=document.getElementById(a),o=document.getElementById(e),s=document.getElementById(t);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Re(a,e,t){return a?!0:(V(e,t),!1)}function Yt(a,e){if(!a)return V(e,p.get("validation_email_required")),!1;const t=(a.match(/@/g)||[]).length,n=(a.match(/\./g)||[]).length;return t!==1||n<1?(V(e,p.get("validation_email_invalid")),!1):!0}function Wt(a,e){if(!a)return V(e,p.get("validation_password_required")),!1;const t=Be(a);return t.length>0?(V(e,Ve(t)),!1):!0}function V(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function Kt(a,e,t,n,o,s){const r=document.querySelector('button[type="submit"]');try{const d=_e(s),_={email:t,hash:d,first:a,last:e};n&&(_.company=n),o&&(_.phone=o);const h=await F.doSignup(_);if(h.ok)i.publish(l.AUTH_SIGNUP_SUCCESS,{email:t}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const E=h.error||h.message||p.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(E,"danger"),r.disabled=!1,r.textContent=p.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:E})}}catch(d){console.error("[SignupRoute] Sign up error:",d),typeof neodigmToast<"u"&&neodigmToast.q(d.message||p.get("error_network"),"danger"),r.disabled=!1,r.textContent=p.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:d.message})}}const Jt=Object.freeze(Object.defineProperty({__proto__:null,init:jt,render:qt},Symbol.toStringTag,{value:"Module"}));function Qt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function dn(){console.log("[ResethashRoute] Initialized");const a=document.getElementById("resethash-form"),e=a.querySelector('button[type="submit"]');ke("toggleNewPassword","new-password","eyeIconNew"),ke("toggleConfirmPassword","confirm-password","eyeIconConfirm"),a?.addEventListener("submit",async t=>{t.preventDefault();const n=a.email.value.trim(),o=a.newPassword.value,s=a.confirmPassword.value,r=document.getElementById("new-password"),d=document.getElementById("confirm-password");if(!o){B(r,p.get("validation_new_password_required"));return}const _=Be(o);if(_.length>0){B(r,Ve(_));return}if(!s){B(d,p.get("validation_new_password_required"));return}if(o!==s){B(d,p.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=p.get("loading_resetting_password");try{const h=_e(o),E=await F.doResetHash(n,h);E.ok?(typeof neodigmToast<"u"&&neodigmToast.q(p.get("success_password_reset"),"success"),i.publish(l.AUTH_RESETHASH_SUCCESS,{email:n})):(B(r,E.error||p.get("error_signin_failed")),e.disabled=!1,e.textContent=p.get("update_password").toUpperCase())}catch(h){console.error("[ResethashRoute] Reset password error:",h),B(r,h.message||p.get("error_network")),e.disabled=!1,e.textContent=p.get("update_password").toUpperCase()}})}function ke(a,e,t){const n=document.getElementById(a),o=document.getElementById(e),s=document.getElementById(t);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
    ...
    `}renderButton(e,t,n="primary"){const o=n==="primary"?e.token===this.selectedPrimaryToken:!1,s=typeof e.count=="number"&&e.count!==null&&e.count!==void 0,r=e.icon&&e.icon.trim()!=="",d=e.tagline&&e.tagline.trim()!=="";return`
      <button

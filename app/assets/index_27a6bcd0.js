(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const Qe="modulepreload",Xe=function(a){return"/"+a},be={},k=function(e,n,t){let o=Promise.resolve();if(n&&n.length>0){let p=function(_){return Promise.all(_.map(v=>Promise.resolve(v).then(w=>({status:"fulfilled",value:w}),w=>({status:"rejected",reason:w}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=s?.nonce||s?.getAttribute("nonce");o=p(n.map(_=>{if(_=Xe(_),_ in be)return;be[_]=!0;const v=_.endsWith(".css"),w=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${_}"]${w}`))return;const y=document.createElement("link");if(y.rel=v?"stylesheet":Qe,v||(y.as="script"),y.crossOrigin="",y.href=_,c&&y.setAttribute("nonce",c),document.head.appendChild(y),v)return new Promise((C,R)=>{y.addEventListener("load",C),y.addEventListener("error",()=>R(new Error(`Unable to preload CSS for ${_}`)))})}))}function r(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return o.then(s=>{for(const c of s||[])c.status==="rejected"&&r(c.reason);return e().catch(r)})};var Ze=/([:*])(\w+)/g,et="([^/]+)",tt=/\*/g,nt="?(?:.*)",at=/\/\?/g,ot="/?([^/]+|)",rt="(?:/^|^)",st="";function Me(a){return a===void 0&&(a="/"),ue()?location.pathname+location.search+location.hash:a}function T(a){return a.replace(/\/+$/,"").replace(/^\/+/,"")}function Q(a){return typeof a=="string"}function it(a){return typeof a=="function"}function X(a){return a&&a.indexOf("#")>=0&&a.split("#").pop()||""}function lt(a,e){return e.length===0||!a?null:a.slice(1,a.length).reduce(function(n,t,o){return n===null&&(n={}),n[e[o]]=decodeURIComponent(t),n},null)}function Z(a){var e=T(a).split(/\?(.*)?$/);return[T(e[0]),e.slice(1).join("")]}function de(a){for(var e={},n=a.split("&"),t=0;t<n.length;t++){var o=n[t].split("=");if(o[0]!==""){var r=decodeURIComponent(o[0]);e[r]?(Array.isArray(e[r])||(e[r]=[e[r]]),e[r].push(decodeURIComponent(o[1]||""))):e[r]=decodeURIComponent(o[1]||"")}}return e}function Pe(a,e){var n=Z(T(a.currentLocationPath)),t=n[0],o=n[1],r=o===""?null:de(o),s=[],c;if(Q(e.path)){if(c=rt+T(e.path).replace(Ze,function(w,y,C){return s.push(C),et}).replace(tt,nt).replace(at,ot)+"$",T(e.path)===""&&T(t)==="")return{url:t,queryString:o,hashString:X(a.to),route:e,data:null,params:r}}else c=e.path;var p=new RegExp(c,st),_=t.match(p);if(_){var v=Q(e.path)?lt(_,s):_.groups?_.groups:_.slice(1);return{url:T(t.replace(new RegExp("^"+a.instance.root),"")),queryString:o,hashString:X(a.to),route:e,data:v,params:r}}return!1}function Ue(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function G(a,e){return typeof a[e]>"u"||a[e]===!0}function ct(a){if(!a)return{};var e=a.split(","),n={},t;return e.forEach(function(o){var r=o.split(":").map(function(s){return s.replace(/(^ +| +$)/g,"")});switch(r[0]){case"historyAPIMethod":n.historyAPIMethod=r[1];break;case"resolveOptionsStrategy":t||(t={}),t.strategy=r[1];break;case"resolveOptionsHash":t||(t={}),t.hash=r[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":n[r[0]]=r[1]==="true";break}}),t&&(n.resolveOptions=t),n}function ue(){return typeof window<"u"}function dt(a,e){return a===void 0&&(a=[]),e===void 0&&(e={}),a.filter(function(n){return n}).forEach(function(n){["before","after","already","leave"].forEach(function(t){n[t]&&(e[t]||(e[t]=[]),e[t].push(n[t]))})}),e}function U(a,e,n){var t=e||{},o=0;(function r(){if(!a[o]){n&&n(t);return}Array.isArray(a[o])?(a.splice.apply(a,[o,1].concat(a[o][0](t)?a[o][1]:a[o][2])),r()):a[o](t,function(s){typeof s>"u"||s===!0?(o+=1,r()):n&&n(t)})})()}U.if=function(a,e,n){return Array.isArray(e)||(e=[e]),Array.isArray(n)||(n=[n]),[a,e,n]};function Ee(a,e){typeof a.currentLocationPath>"u"&&(a.currentLocationPath=a.to=Me(a.instance.root)),a.currentLocationPath=a.instance._checkForAHash(a.currentLocationPath),e()}function ae(a,e){for(var n=0;n<a.instance.routes.length;n++){var t=a.instance.routes[n],o=Pe(a,t);if(o&&(a.matches||(a.matches=[]),a.matches.push(o),a.resolveOptions.strategy==="ONE")){e();return}}e()}function ut(a,e){a.navigateOptions&&(typeof a.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof a.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),e()}function gt(a,e){a.navigateOptions.force===!0?(a.instance._setCurrent([a.instance._pathToMatchObject(a.to)]),e(!1)):e()}var ye=ue(),pt=Ue();function _t(a,e){if(G(a.navigateOptions,"updateBrowserURL")){var n=("/"+a.to).replace(/\/\//g,"/"),t=ye&&a.resolveOptions&&a.resolveOptions.hash===!0;pt?(history[a.navigateOptions.historyAPIMethod||"pushState"](a.navigateOptions.stateObj||{},a.navigateOptions.title||"",t?"#"+n:n),location&&location.hash&&(a.instance.__freezeListening=!0,setTimeout(function(){if(!t){var o=location.hash;location.hash="",location.hash=o}a.instance.__freezeListening=!1},1))):ye&&(window.location.href=a.to)}e()}function Fe(a,e){var n=a.instance;if(!n.lastResolved()){e();return}U(n.lastResolved().map(function(t){return function(o,r){if(!t.route.hooks||!t.route.hooks.leave){r();return}var s=!1,c=a.instance.matchLocation(t.route.path,a.currentLocationPath,!1);if(t.route.path!=="*")s=!c;else{var p=a.matches?a.matches.find(function(_){return t.route.path===_.route.path}):!1;s=!p}if(G(a.navigateOptions,"callHooks")&&s){U(t.route.hooks.leave.map(function(_){return function(v,w){return _(function(y){y===!1?a.instance.__markAsClean(a):w()},a.matches&&a.matches.length>0?a.matches.length===1?a.matches[0]:a.matches:void 0)}}).concat([function(){return r()}]));return}else r()}}),{},function(){return e()})}function mt(a,e){a.match.route.hooks&&a.match.route.hooks.before&&G(a.navigateOptions,"callHooks")?U(a.match.route.hooks.before.map(function(n){return function(o,r){return n(function(s){s===!1?a.instance.__markAsClean(a):r()},a.match)}}).concat([function(){return e()}])):e()}function ht(a,e){G(a.navigateOptions,"callHandler")&&a.match.route.handler(a.match),a.instance.updatePageLinks(),e()}function ft(a,e){a.match.route.hooks&&a.match.route.hooks.after&&G(a.navigateOptions,"callHooks")&&a.match.route.hooks.after.forEach(function(n){return n(a.match)}),e()}function vt(a,e){var n=a.instance.lastResolved();if(n&&n[0]&&n[0].route===a.match.route&&n[0].url===a.match.url&&n[0].queryString===a.match.queryString){n.forEach(function(t){t.route.hooks&&t.route.hooks.already&&G(a.navigateOptions,"callHooks")&&t.route.hooks.already.forEach(function(o){return o(a.match)})}),e(!1);return}e()}function bt(a,e){var n=a.instance._notFoundRoute;if(n){a.notFoundHandled=!0;var t=Z(a.currentLocationPath),o=t[0],r=t[1],s=X(a.to);n.path=T(o);var c={url:n.path,queryString:r,hashString:s,data:null,route:n,params:r!==""?de(r):null};a.matches=[c],a.match=c}e()}function Et(a,e){(!a.resolveOptions||a.resolveOptions.noMatchWarning===!1||typeof a.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+a.currentLocationPath+`" didn't match any of the registered routes.`),e()}function yt(a,e){a.instance._setCurrent(null),e()}function De(a,e){G(a.navigateOptions,"updateState")&&a.instance._setCurrent(a.matches),e()}var xe=[vt,mt,ht,ft],Se=[Fe,bt,U.if(function(a){var e=a.notFoundHandled;return e},xe.concat([De]),[Et,yt])];function le(){return le=Object.assign||function(a){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(a[t]=n[t])}return a},le.apply(this,arguments)}function Ae(a,e){var n=0;function t(){if(n===a.matches.length){De(a,e);return}U(xe,le({},a,{match:a.matches[n]}),function(){n+=1,t()})}Fe(a,t)}function oe(a){a.instance.__markAsClean(a)}function ce(){return ce=Object.assign||function(a){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(a[t]=n[t])}return a},ce.apply(this,arguments)}var we="[data-navigo]";function St(a,e){var n=e||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:we},t=this,o="/",r=null,s=[],c=!1,p,_=Ue(),v=ue();a?o=T(a):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function w(d){return d.indexOf("#")>=0&&(n.hash===!0?d=d.split("#")[1]||"/":d=d.split("#")[0]),d}function y(d){return T(o+"/"+T(d))}function C(d,g,b,A){return d=Q(d)?y(d):d,{name:A||T(String(d)),path:d,handler:g,hooks:dt(b)}}function R(d,g,b){var A=this;return typeof d=="object"&&!(d instanceof RegExp)?(Object.keys(d).forEach(function(E){if(typeof d[E]=="function")A.on(E,d[E]);else{var P=d[E],z=P.uses,Ke=P.as,Je=P.hooks;s.push(C(E,z,[p,Je],Ke))}}),this):(typeof d=="function"&&(b=g,g=d,d=o),s.push(C(d,g,[p,b])),this)}function u(d,g){if(t.__dirty){t.__waiting.push(function(){return t.resolve(d,g)});return}else t.__dirty=!0;d=d?T(o)+"/"+T(d):void 0;var b={instance:t,to:d,currentLocationPath:d,navigateOptions:{},resolveOptions:ce({},n,g)};return U([Ee,ae,U.if(function(A){var E=A.matches;return E&&E.length>0},Ae,Se)],b,oe),b.matches?b.matches:!1}function h(d,g){if(t.__dirty){t.__waiting.push(function(){return t.navigate(d,g)});return}else t.__dirty=!0;d=T(o)+"/"+T(d);var b={instance:t,to:d,navigateOptions:g||{},resolveOptions:g&&g.resolveOptions?g.resolveOptions:n,currentLocationPath:w(d)};U([ut,gt,ae,U.if(function(A){var E=A.matches;return E&&E.length>0},Ae,Se),_t,oe],b,oe)}function f(d,g,b){var A=he(d,g);return A!==null?(h(A.replace(new RegExp("^/?"+o),""),b),!0):!1}function L(d){return this.routes=s=s.filter(function(g){return Q(d)?T(g.path)!==T(d):it(d)?d!==g.handler:String(g.path)!==String(d)}),this}function O(){_&&(this.__popstateListener=function(){t.__freezeListening||u()},window.addEventListener("popstate",this.__popstateListener))}function N(){this.routes=s=[],_&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=c=!0}function F(d,g){return t._notFoundRoute=C("*",d,[p,g],"__NOT_FOUND__"),this}function M(){if(v)return H().forEach(function(d){if(d.getAttribute("data-navigo")==="false"||d.getAttribute("target")==="_blank"){d.hasListenerAttached&&d.removeEventListener("click",d.navigoHandler);return}d.hasListenerAttached||(d.hasListenerAttached=!0,d.navigoHandler=function(g){if((g.ctrlKey||g.metaKey)&&g.target.tagName.toLowerCase()==="a")return!1;var b=d.getAttribute("href");if(typeof b>"u"||b===null)return!1;if(b.match(/^(http|https)/)&&typeof URL<"u")try{var A=new URL(b);b=A.pathname+A.search}catch{}var E=ct(d.getAttribute("data-navigo-options"));c||(g.preventDefault(),g.stopPropagation(),t.navigate(T(b),E))},d.addEventListener("click",d.navigoHandler))}),t}function H(){return v?[].slice.call(document.querySelectorAll(n.linksSelector||we)):[]}function ne(d){return"/"+o+"/"+T(d)}function q(d){return p=d,this}function $e(){return r}function he(d,g,b){var A=s.find(function(z){return z.name===d}),E=null;if(A){if(E=A.path,g)for(var P in g)E=E.replace(":"+P,g[P]);E=E.match(/^\//)?E:"/"+E}return E&&b&&!b.includeRoot&&(E=E.replace(new RegExp("^/"+o),"")),E}function qe(d){return d.getAttribute("href")}function fe(d){var g=Z(T(d)),b=g[0],A=g[1],E=A===""?null:de(A),P=X(d),z=C(b,function(){},[p],b);return{url:b,queryString:A,hashString:P,route:z,data:null,params:E}}function ze(){return fe(T(Me(o)).replace(new RegExp("^"+o),""))}function je(d){var g={instance:t,currentLocationPath:d,to:d,resolveOptions:n};return ae(g,function(){}),g.matches?g.matches:!1}function Ye(d,g,b){typeof g<"u"&&(typeof b>"u"||b)&&(g=y(g));var A={instance:t,to:g,currentLocationPath:g};Ee(A,function(){}),typeof d=="string"&&(d=typeof b>"u"||b?y(d):d);var E=Pe(A,{name:String(d),path:d,handler:function(){},hooks:{}});return E||!1}function W(d,g,b){return typeof g=="string"&&(g=ve(g)),g?(g.hooks[d]||(g.hooks[d]=[]),g.hooks[d].push(b),function(){g.hooks[d]=g.hooks[d].filter(function(A){return A!==b})}):(console.warn("Route doesn't exists: "+g),function(){})}function ve(d){return typeof d=="string"?s.find(function(g){return g.name===y(d)}):s.find(function(g){return g.handler===d})}function We(d){d.instance.__dirty=!1,d.instance.__waiting.length>0&&d.instance.__waiting.shift()()}this.root=o,this.routes=s,this.destroyed=c,this.current=r,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=We,this.on=R,this.off=L,this.resolve=u,this.navigate=h,this.navigateByName=f,this.destroy=N,this.notFound=F,this.updatePageLinks=M,this.link=ne,this.hooks=q,this.extractGETParameters=function(d){return Z(w(d))},this.lastResolved=$e,this.generate=he,this.getLinkPath=qe,this.match=je,this.matchLocation=Ye,this.getCurrentLocation=ze,this.addBeforeHook=W.bind(this,"before"),this.addAfterHook=W.bind(this,"after"),this.addAlreadyHook=W.bind(this,"already"),this.addLeaveHook=W.bind(this,"leave"),this.getRoute=ve,this._pathToMatchObject=fe,this._clean=T,this._checkForAHash=w,this._setCurrent=function(d){return r=t.current=d},O.call(this),M.call(this)}var At=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function wt(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var j={exports:{}},Tt=j.exports,Te;function Ct(){return Te||(Te=1,(function(a,e){(function(n,t){var o={};n.PubSub?(o=n.PubSub,console.warn("PubSub already loaded, using existing version")):(n.PubSub=o,t(o)),a!==void 0&&a.exports&&(e=a.exports=o),e.PubSub=o,a.exports=e=o})(typeof window=="object"&&window||Tt||At,function(n){var t={},o=-1,r="*";function s(u){var h;for(h in u)if(Object.prototype.hasOwnProperty.call(u,h))return!0;return!1}function c(u){return function(){throw u}}function p(u,h,f){try{u(h,f)}catch(L){setTimeout(c(L),0)}}function _(u,h,f){u(h,f)}function v(u,h,f,L){var O=t[h],N=L?_:p,F;if(Object.prototype.hasOwnProperty.call(t,h))for(F in O)Object.prototype.hasOwnProperty.call(O,F)&&N(O[F],u,f)}function w(u,h,f){return function(){var O=String(u),N=O.lastIndexOf(".");for(v(u,u,h,f);N!==-1;)O=O.substr(0,N),N=O.lastIndexOf("."),v(u,O,h,f);v(u,r,h,f)}}function y(u){var h=String(u),f=!!(Object.prototype.hasOwnProperty.call(t,h)&&s(t[h]));return f}function C(u){for(var h=String(u),f=y(h)||y(r),L=h.lastIndexOf(".");!f&&L!==-1;)h=h.substr(0,L),L=h.lastIndexOf("."),f=y(h);return f}function R(u,h,f,L){u=typeof u=="symbol"?u.toString():u;var O=w(u,h,L),N=C(u);return N?(f===!0?O():setTimeout(O,0),!0):!1}n.publish=function(u,h){return R(u,h,!1,n.immediateExceptions)},n.publishSync=function(u,h){return R(u,h,!0,n.immediateExceptions)},n.subscribe=function(u,h){if(typeof h!="function")return!1;u=typeof u=="symbol"?u.toString():u,Object.prototype.hasOwnProperty.call(t,u)||(t[u]={});var f="uid_"+String(++o);return t[u][f]=h,f},n.subscribeAll=function(u){return n.subscribe(r,u)},n.subscribeOnce=function(u,h){var f=n.subscribe(u,function(){n.unsubscribe(f),h.apply(this,arguments)});return n},n.clearAllSubscriptions=function(){t={}},n.clearSubscriptions=function(h){var f;for(f in t)Object.prototype.hasOwnProperty.call(t,f)&&f.indexOf(h)===0&&delete t[f]},n.countSubscriptions=function(h){var f,L,O=0;for(f in t)if(Object.prototype.hasOwnProperty.call(t,f)&&f.indexOf(h)===0){for(L in t[f])O++;break}return O},n.getSubscriptions=function(h){var f,L=[];for(f in t)Object.prototype.hasOwnProperty.call(t,f)&&f.indexOf(h)===0&&L.push(f);return L},n.unsubscribe=function(u){var h=function(ne){var q;for(q in t)if(Object.prototype.hasOwnProperty.call(t,q)&&q.indexOf(ne)===0)return!0;return!1},f=typeof u=="string"&&(Object.prototype.hasOwnProperty.call(t,u)||h(u)),L=!f&&typeof u=="string",O=typeof u=="function",N=!1,F,M,H;if(f){n.clearSubscriptions(u);return}for(F in t)if(Object.prototype.hasOwnProperty.call(t,F)){if(M=t[F],L&&M[u]){delete M[u],N=u;break}if(O)for(H in M)Object.prototype.hasOwnProperty.call(M,H)&&M[H]===u&&(delete M[H],N=!0)}return N}})})(j,j.exports)),j.exports}var Lt=Ct();const i=wt(Lt),l=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",LLM:"LLM",LLM_DO_DOWNLOAD:"LLM.DO.DOWNLOAD",LLM_STATUS:"LLM.STATUS",LLM_COMPLETE:"LLM.COMPLETE",LLM_ERROR:"LLM.ERROR",LLM_PROMPT:"LLM.PROMPT",LLM_RESPONSE:"LLM.RESPONSE",LLM_CANCEL:"LLM.CANCEL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Ot=5e3;function Rt(a){if(a===null||typeof a!="object")return a;try{return structuredClone(a)}catch{return Nt(a)}}function Nt(a){const e={_vcrPartial:!0};for(const n of Object.keys(a))try{const t=a[n];e[n]=t===null||typeof t!="object"?t:`[${Object.prototype.toString.call(t).slice(8,-1)}]`}catch(t){e[n]=`[unreadable: ${t.message}]`}return e}function It(a){const e=new WeakSet;return JSON.stringify(a,(n,t)=>{if(typeof t=="bigint")return`${t}n`;if(typeof t=="function")return"[Function]";if(typeof t=="object"&&t!==null){if(e.has(t))return"[Circular]";e.add(t)}return t},2)}function kt(a,e={}){if(!a||typeof a.publish!="function")return console.warn("[VCR] PubSub.publish not found - recorder not installed"),null;if(a.publish.__vcr)return a.publish.__vcr;const n=e.maxEntries??Ot,t=e.app??"",o=[];let r=0,s=0,c=0;window._vcrTimeline=o,window._isVCRRecording=!1;function p(v,w,y){o.length>=n&&(o.shift(),c++);const C=Date.now(),R={seq:r++,message:v,data:Rt(w),timestamp:C,elapsed:C-s};y&&(R.sync=!0),t&&(R.app=t),o.push(R)}const _={start(){return o.length=0,r=0,c=0,s=Date.now(),window._isVCRRecording=!0,console.info(`[VCR] recording (cap ${n} events) - reproduce the issue, then run stopVCR()`),!0},stop(){return window._isVCRRecording=!1,c&&console.warn(`[VCR] tape capped at ${n} - ${c} earlier event(s) dropped`),console.info(`[VCR] stopped - ${o.length} event(s) recorded`),It(o)},peek(){return o},uninstall(){window._isVCRRecording=!1;for(const v of["publish","publishSync"])a[v]&&a[v].__vcrOriginal&&(a[v]=a[v].__vcrOriginal)}};for(const v of["publish","publishSync"]){const w=a[v];if(typeof w!="function")continue;const y=v==="publishSync",C=function(R,u){if(window._isVCRRecording)try{p(R,u,y)}catch(h){console.warn("[VCR] failed to record",R,h)}return w.apply(this,arguments)};C.__vcr=_,C.__vcrOriginal=w,a[v]=C}return window.startVCR=()=>_.start(),window.stopVCR=()=>_.stop(),_}const re={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://streamsyncengage-saas.onrender.com"};var se={};const S=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel"});function Ge(a,e=null){if(a in S)return S[a];if(typeof process<"u"&&se&&se[a]){const n=se[a];return n==="true"?!0:n==="false"?!1:isNaN(n)?n:Number(n)}if(typeof import.meta<"u"&&re&&re[a]){const n=re[a];return n==="true"?!0:n==="false"?!1:isNaN(n)?n:Number(n)}return e}function Mt(a){return Ge(a,!1)===!0}function Pt(){return{...S}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:S,getFlag:Ge,isEnabled:Mt,getAllFlags:Pt});function Ut(){const a=e=>n=>{const t=n.detail?.pubsubTopic;t&&i.publish(t,n.detail)};document.addEventListener("nav-select",a()),document.addEventListener("logo-click",a()),document.addEventListener("nav-hover",a()),document.addEventListener("nav-double-tap",a()),document.addEventListener("nav-long-tap",a()),document.addEventListener("message-sent",a())}function Ft(){console.log("[AppEvents] Initializing event listeners..."),i.subscribe(l.APP_READY,(n,t)=>{console.log("[AppEvents] APP_READY:",t)}),i.subscribe(l.APP_ERROR,(n,t)=>{console.error("[AppEvents] APP_ERROR:",t)}),i.subscribe(l.APP_SIGNOUT,(n,t)=>{console.log("[AppEvents] APP_SIGNOUT:",t)}),i.subscribe(l.ROUTE_NAV_BEFORE,(n,t)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",t),i.publish(l.UI_LOADING_START)}),i.subscribe(l.ROUTE_NAV_AFTER,(n,t)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",t),i.publish(l.UI_LOADING_END)}),i.subscribe(l.ROUTE_NAV_ERROR,(n,t)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",t),i.publish(l.APP_ERROR,{message:"Navigation error",details:t})}),i.subscribe(l.AUTH_SIGNIN_SUCCESS,(n,t)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",t)}),i.subscribe(l.AUTH_SIGNIN_FAIL,(n,t)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",t),i.publish(l.UI_TOAST,{message:t.message||"Sign in failed",type:"danger"})}),i.subscribe(l.AUTH_SIGNUP_SUCCESS,(n,t)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",t),i.publish(l.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"})}),i.subscribe(l.AUTH_VERIFY_LINK,(n,t)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),i.subscribe(l.AUTH_SIGNUP_FAIL,(n,t)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",t),i.publish(l.UI_TOAST,{message:t.message||"Sign up failed",type:"danger"})}),i.subscribe(l.AUTH_SIGNOUT_SUCCESS,(n,t)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",t),i.publish(l.UI_TOAST,{message:"Signed out successfully",type:"info"})}),i.subscribe(l.AUTH_SIGNUP,(n,t)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),i.subscribe(l.AUTH_FORGOT,(n,t)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),i.subscribe(l.AUTH_FORGOT_SUCCESS,(n,t)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",t),i.publish(l.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),i.subscribe(l.AUTH_RESETHASH_NAV,(n,t)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),i.subscribe(l.AUTH_RESETHASH_SUCCESS,(n,t)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",t),i.publish(l.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),i.subscribe(l.AUTH_TOKEN_EXPIRED,(n,t)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",t),i.publish(l.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),i.subscribe(l.I18N_SET_LANG,(n,t)=>{console.log("[AppEvents] I18N_SET_LANG:",t);const{langCode:o}=t;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),i.publish(l.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(r){console.error("[AppEvents] Error changing language:",r),i.publish(l.UI_TOAST,{message:`Failed to change language: ${r.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),i.subscribe("CONVERSATION.PROMPT",(n,t)=>{const o=n.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,t),!t||!t.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",t.message),K(t.message,"user",t.timestamp),i.publish(l.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Send prompt to agent:",t.message),i.publish(l.LLM_PROMPT,{message:t.message});break;case"AGENT_CANVAS":if(t.message&&t.message.startsWith("::")){console.log("[AppEvents] CLI command detected:",t.message),K(t.message,"user",t.timestamp),i.publish(l.CANVAS_DO_SCROLL),(async()=>{const r=(await k(async()=>{const{default:p}=await Promise.resolve().then(()=>Vt);return{default:p}},void 0)).default,s=window.AuthController?.getEntity(),c=await r.process(t.message,s);i.publish(l.CONVERSATION_RESPONSE_CANVAS,{message:c.message,timestamp:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}),i.publish(l.CANVAS_DO_SCROLL)})();break}console.log("[AppEvents] Send prompt to agent + canvas:",t.message),K(t.message,"user",t.timestamp),i.publish(l.CANVAS_DO_SCROLL),i.publish(l.LLM_PROMPT,{message:t.message});break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",t.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),i.subscribe("CONVERSATION.RESPONSE",(n,t)=>{const o=n.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,t),!t||!t.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",t.message),K(t.message,"assistant",t.timestamp,t.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",t.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),i.subscribe(l.UI_LOADING_START,(n,t)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),i.subscribe(l.UI_LOADING_END,(n,t)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),i.subscribe(l.UI_TOAST,(n,t)=>{console.log("[AppEvents] UI_TOAST:",t)}),i.subscribe(l.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const n="0.1",t=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${n} 7/31/2026, 6:18:39 PM|© ${t} Mach Five Tech`,"night")}),Ut(),i.subscribe("M5T_PRIMARY_NAV",(n,t)=>{const o=n.split(".")[1];switch(o){case"TAP":a(t);break;case"LOGO_TAP":e();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function a(n){const{token:t,level:o,primaryToken:r}=n;switch(t){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),i.publish(l.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${t}`,{primaryToken:r});break}}function e(n){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 7/31/2026, 6:18:39 PM|© ${o} Mach Five Tech`,"night",5e3)}i.subscribe(l.LLM_DO_DOWNLOAD,(n,t)=>{console.log("[AppEvents] LLM_DO_DOWNLOAD:",t),window.LLMController?window.LLMController.loadModel():console.error("[AppEvents] LLMController not available")}),i.subscribe(l.LLM_STATUS,(n,t)=>{console.log("[AppEvents] LLM_STATUS:",t),t&&typeof neodigmToast<"u"&&(t.text||`${t.progressPercent}`)}),i.subscribe(l.LLM_COMPLETE,(n,t)=>{console.log("[AppEvents] LLM_COMPLETE:",t),i.publish(l.CONVERSATION_RESPONSE_CANVAS,{message:`✓ AI Model Ready: ${t.modelId}`,timestamp:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})})}),i.subscribe(l.LLM_ERROR,(n,t)=>{console.error("[AppEvents] LLM_ERROR:",t);const o=`AI Error: ${t.error||"Unknown error"}`;typeof neodigmToast<"u"&&neodigmToast.q(o,"danger",8e3),i.publish(l.CONVERSATION_RESPONSE_CANVAS,{message:`✗ ${o}`,timestamp:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})})}),i.subscribe(l.LLM_PROMPT,(n,t)=>{console.log("[AppEvents] LLM_PROMPT:",t),window.LLMController&&t?.message?window.LLMController.chat(t.message):console.error("[AppEvents] LLMController not available or no message provided")}),i.subscribe(l.LLM_RESPONSE,(n,t)=>{console.log("[AppEvents] LLM_RESPONSE:",t),!t?.done&&t?.fullContent&&i.publish(l.CONVERSATION_RESPONSE_CANVAS,{message:t.fullContent,timestamp:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),streaming:!0})}),i.subscribe(l.LLM_CANCEL,(n,t)=>{console.log("[AppEvents] LLM_CANCEL"),window.LLMController&&window.LLMController.cancelGeneration()}),i.subscribe(l.AUTH_SIGNOUT,(n,t)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(S.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function K(a,e="user",n=null,t=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(n||(n=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),t&&e==="assistant"){const s=o.firstElementChild;if(s&&s.tagName.toLowerCase()==="m5t-chat-response"){s.setAttribute("message",a),console.log(`[AppEvents] Updated streaming ${e} bubble (${a.length} chars)`);return}}let r;e==="user"||e==="prompt"?r=document.createElement("m5t-chat-prompt"):r=document.createElement("m5t-chat-response"),r.setAttribute("message",a),r.setAttribute("timestamp",n),o.prepend(r),console.log(`[AppEvents] Added ${e} bubble to canvas (${a.length} chars)`)}class D{static CONFIG={BASE_URL:"https://streamsyncengage-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#n=null;static#a=null;static#s=null;static async init({BASE_URL:e,navigateFunction:n,customConfig:t={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(n&&typeof n=="function")this.#s=n;else throw new Error("navigateFunction is required and must be a function");return e&&(this.CONFIG.BASE_URL=e),t&&Object.keys(t).length>0&&(this.CONFIG={...this.CONFIG,...t}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#c(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#d(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#l(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((e=null)=>{e&&(console.log("[AuthController] mvvLegit navigation to:",e),this.#o(e))}).setOnState((e=null)=>{if(e)switch(console.log("[AuthController] Auth state changed:",e),e){case"AUTH":case 4:this.#p();break;case"UNAUTH":case 1:this.#_();break;case"UNVERF":case 2:this.#m();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#o(e){if(!this.#s){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",e);const n=e.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",n),this.#s(n)}static#c(){try{const e=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);e&&(this.#n=JSON.parse(e),console.log("[AuthController] Entity state loaded:",this.#n?.email))}catch(e){console.error("[AuthController] Error loading entity state:",e),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#n=null}this.#a=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null}static#r(e){try{this.#n=e,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(e)),console.log("[AuthController] Entity state saved")}catch(n){console.error("[AuthController] Error saving entity state:",n)}}static#i(){this.#n=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY)}static getEntity(){return this.#n}static async doSignin(e,n){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,hash:n})}),o=await t.json();return t.status===303?(console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#r(o.entity)),setTimeout(()=>{this.#o(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o}):t.ok&&o.accessToken?(console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#r(o.entity),console.log("[AuthController] Explicitly navigating to home"),this.#o(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}):{ok:!1,error:o.error||"Sign in failed",data:o}}catch(t){return console.error("[AuthController] Signin error:",t),{ok:!1,error:t.message}}}static async doSignout(e=!1){console.log("[AuthController] doSignout called, serverInitiated:",e);try{const n=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!n),!e&&n){const t=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(n)}`;if(console.log("[AuthController] Sending signout beacon to:",t),navigator.sendBeacon){const o=navigator.sendBeacon(t);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else n||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#i(),console.log("[AuthController] Stopping auth ping..."),this.#u(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(n){console.error("[AuthController] Signout error:",n),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(e){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),t=await n.json();return n.ok&&t.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#r(t.entity),{ok:!0,data:t}):{ok:!1,error:t.error||"Sign up failed",data:t}}catch(n){return console.error("[AuthController] Signup error:",n),{ok:!1,error:n.message}}}static async doResetHash(e,n){try{const t=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({email:e,hash:n,modified_by:e})}),r=await o.json();return o.ok&&r.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:r}):{ok:!1,error:r.error||"Password reset failed",data:r}}catch(t){return console.error("[AuthController] Reset password error:",t),{ok:!1,error:t.message}}}static#d(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#g()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#u(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#g(){try{const e=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);e.ok?console.log("[AuthController] Ping success"):(e.status===401||e.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(e){console.error("[AuthController] Ping error:",e)}}static setDeepLinkGuid(e){this.#a=e,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,e),console.log("[AuthController] Deep-link GUID stored:",e)}static getDeepLinkGuid(){return this.#a}static clearDeepLink(){this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#p(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#d()}static#_(){console.log("[AuthController] User unauthenticated"),this.#u()}static#m(){console.log("[AuthController] User unverified")}static getAuthState(){try{const e=mvvLegit.getConf()?.LSKEY||"mvv",n=localStorage.getItem(e);if(!n)return"UNAUTH";if(typeof LZString>"u")return null;const t=LZString.decompressFromUTF16(n),r=JSON.parse(t)?.state;return r===1?"UNAUTH":r===2?"UNVERF":r===4?"AUTH":r===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(e){this.#o(e)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#g()}}class m{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:e,product:n,whitelabel:t,lang:o}){e&&(this.#t.buildMode=e),n&&(this.#t.product=n),t&&(this.#t.whitelabel=t),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(e,n={}){const t={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:c}=t;try{const p=this.#e[o]?.[r]?.[s]?.[c]?.[e];return p?Array.isArray(p)?p[Math.floor(Math.random()*p.length)]:p:(console.warn(`[MicrocopyManager] Token not found: ${e} (${o}/${r}/${s}/${c})`),null)}catch(p){return console.error(`[MicrocopyManager] Error retrieving token: ${e}`,p),null}}static getAll(e={}){const n={...this.#t,...e},{buildMode:t,product:o,whitelabel:r,lang:s}=n;try{return this.#e[t]?.[o]?.[r]?.[s]||null}catch(c){return console.error("[MicrocopyManager] Error retrieving all tokens",c),null}}static has(e,n={}){const t={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:c}=t;try{return!!this.#e[o]?.[r]?.[s]?.[c]?.[e]}catch{return!1}}static getAvailableLanguages(){const{buildMode:e,product:n,whitelabel:t}=this.#t;try{return Object.keys(this.#e[e]?.[n]?.[t]||{})}catch{return[]}}static update(e,n,t={}){const o={...this.#t,...t},{buildMode:r,product:s,whitelabel:c,lang:p}=o;try{return this.#e[r]||(this.#e[r]={}),this.#e[r][s]||(this.#e[r][s]={}),this.#e[r][s][c]||(this.#e[r][s][c]={}),this.#e[r][s][c][p]||(this.#e[r][s][c][p]={}),this.#e[r][s][c][p][e]=n,!0}catch(_){return console.error(`[MicrocopyManager] Error updating token: ${e}`,_),!1}}static delete(e,n={}){const t={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:c}=t;try{return delete this.#e[o]?.[r]?.[s]?.[c]?.[e],!0}catch(p){return console.error(`[MicrocopyManager] Error deleting token: ${e}`,p),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(e){try{return this.#e=e,!0}catch(n){return console.error("[MicrocopyManager] Error importing data",n),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:m});class x{static#e=!1;static#t=null;static#n=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const e=this.#s();m.setContext(e),console.log("[I18nController] Initialized with context:",e),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#l(),this.#c(),this.#e=!0,this.refresh()}static#a(e){const n={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},t=e.toLowerCase();return n[t]||"DEV"}static#s(){const n=this.#a("production"),t=localStorage.getItem(S.FF_SSE_LS_WHITELABEL)||S.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(S.FF_SSE_LS_USER_LANG)||S.FF_SSE_I18N_LANG;return{buildMode:n,product:S.FF_SSE_I18N_PRODUCT,whitelabel:t,lang:o}}static#l(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((e,n,t)=>{S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",t),this.#t=t,setTimeout(()=>{this.refresh()},S.FF_SSE_I18N_APPLY_DELAY_MS)},S.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#o())}static#o(){setInterval(()=>{const n=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");n&&n!==this.#t&&(this.#t=n,this.refresh())},500)}static#c(){this.#n||(this.#n=new MutationObserver(e=>{let n=!1;for(const t of e){for(const o of t.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){n=!0;break}if(n)break}n&&(S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#n.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#i(document.body),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(e){const n=e.querySelectorAll("[data-meta-copywrite-i118n]");S.FF_SSE_I18N_DEBUG&&n.length>0&&console.log(`[I18nController] Processing ${n.length} elements`),n.forEach(t=>{try{const o=t.getAttribute("data-meta-copywrite-i118n"),r=JSON.parse(o);if(!r.token){console.warn("[I18nController] Missing token in config:",r);return}const s=r.attribute||"textContent",c=m.get(r.token);if(c===null){console.warn(`[I18nController] Microcopy not found for token: ${r.token}`);return}s==="textContent"?t.textContent=c:s==="innerHTML"?t.innerHTML=c:t.setAttribute(s,c),S.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${c}" to ${s} for token: ${r.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,t)}})}static#i(e){e.querySelectorAll("*").forEach(t=>{t.shadowRoot&&(this.#r(t.shadowRoot),this.#i(t.shadowRoot))})}static setLanguage(e){const n=m.getAvailableLanguages();if(!n.includes(e)){console.error(`[I18nController] Language not available: ${e}. Available:`,n);return}localStorage.setItem(S.FF_SSE_LS_USER_LANG,e),m.setContext({lang:e}),console.log("[I18nController] Language changed to:",e);const t=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:e}});document.dispatchEvent(t),this.refresh()}static setWhitelabel(e){localStorage.setItem(S.FF_SSE_LS_WHITELABEL,e),m.setContext({whitelabel:e}),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",e),this.refresh()}static getLanguage(){return m.getContext().lang}static getAvailableLanguages(){return m.getAvailableLanguages()}static getContext(){return m.getContext()}static destroy(){this.#n&&(this.#n.disconnect(),this.#n=null),this.#e=!1,this.#t=null,S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{x.initialize()}):x.initialize());class Ce{static engine=null;static webllm=null;static isInitialized=!1;static currentModel=null;static isGenerating=!1;static isModelCached=!1;static DEFAULT_MODEL="Hermes-2-Pro-Llama-3-8B-q4f32_1-MLC";static messages=[{role:"system",content:"You are a helpful AI assistant running locally in the browser using WebLLM. Be concise and helpful."}];static async initialize(){if(this.isInitialized)return console.log("[LLMController] Already initialized"),!0;console.log("[LLMController] Initializing WebLLM module...");try{if(!navigator.gpu)throw new Error("WebGPU is not available. Please use a supported browser (Chrome 113+, Edge 113+).");if(console.log("[LLMController] WebGPU detected"),this.webllm=await k(()=>import("https://esm.run/@mlc-ai/web-llm"),[]),console.log("[LLMController] WebLLM module loaded"),!this.webllm||!this.webllm.MLCEngine)throw new Error("MLCEngine not found in WebLLM module");return this.engine=new this.webllm.MLCEngine,console.log("[LLMController] MLCEngine created"),this.engine.setInitProgressCallback(e=>{this.handleInitProgress(e)}),this.isModelCached=await this.checkModelCache(),this.isInitialized=!0,console.log("[LLMController] Engine initialized, attempting auto-load..."),await this.autoLoadCachedModel(),console.log("[LLMController] Initialization complete"),!0}catch(e){return console.error("[LLMController] Initialization failed:",e),i.publish(l.LLM_ERROR,{error:e.message,phase:"initialization"}),!1}}static async checkModelCache(){console.log(`[LLMController] Checking cache for model: ${this.DEFAULT_MODEL}`);try{const n=(await caches.keys()).find(c=>c.includes("webllm/model"));if(!n)return console.log("[LLMController] No WebLLM model cache found"),!1;const r=(await(await caches.open(n)).keys()).filter(c=>c.url.includes(this.DEFAULT_MODEL)||c.url.includes("Hermes-2-Pro-Llama-3-8B")),s=r.length>0;return console.log(`[LLMController] Model cached: ${s} (${r.length} files)`),s}catch(e){return console.warn("[LLMController] Cache check failed:",e.message),!1}}static async autoLoadCachedModel(){try{this.isModelCached?console.log(`[LLMController] Loading cached model: ${this.DEFAULT_MODEL}`):console.log(`[LLMController] No cached model found - starting download: ${this.DEFAULT_MODEL}`),await this.loadModel(),console.log("[LLMController] Model ready")}catch(e){console.error("[LLMController] Auto-load failed:",e)}}static async loadModel(){if(!this.isInitialized)return console.error("[LLMController] Cannot load model: not initialized"),i.publish(l.LLM_ERROR,{error:"LLMController not initialized",modelId:this.DEFAULT_MODEL}),!1;const e=this.isModelCached;console.log(`[LLMController] Loading model: ${this.DEFAULT_MODEL} (cached: ${e})`);try{const n={temperature:.7,top_p:.95};return await this.engine.reload(this.DEFAULT_MODEL,n),this.currentModel=this.DEFAULT_MODEL,this.isModelCached=!0,console.log(`[LLMController] Model loaded successfully: ${this.DEFAULT_MODEL}`),i.publish(l.LLM_COMPLETE,{modelId:this.DEFAULT_MODEL,cached:e}),!0}catch(n){return console.error("[LLMController] Failed to load model:",n),i.publish(l.LLM_ERROR,{error:n.message,modelId:this.DEFAULT_MODEL,phase:"download"}),!1}}static handleInitProgress(e){const n=(e.progress*100).toFixed(1);let t=e.text;(n>0||!e.text.includes("Loading model from cache"))&&(t=`${n}% - ${e.text}`),console.log(`[LLMController] Progress: ${t}`),i.publish(l.LLM_STATUS,{progress:e.progress,progressPercent:parseFloat(n),text:t,modelId:this.currentModel||this.DEFAULT_MODEL})}static async chat(e){if(!this.currentModel){console.error("[LLMController] No model loaded - still downloading or initialization failed"),i.publish(l.LLM_ERROR,{error:"AI model is still loading. Please wait a moment and try again.",phase:"chat"});return}if(this.isGenerating){console.warn("[LLMController] Already generating response");return}console.log(`[LLMController] Processing chat message: "${e}"`);const n={role:"user",content:e};this.messages.push(n),this.isGenerating=!0;let t="";try{const o=await this.engine.chat.completions.create({stream:!0,messages:this.messages,stream_options:{include_usage:!0}});for await(const r of o){const s=r.choices[0]?.delta?.content;s&&(t+=s,i.publish(l.LLM_RESPONSE,{content:s,fullContent:t,done:!1})),r.usage&&console.log("[LLMController] Usage stats:",r.usage)}this.messages.push({role:"assistant",content:t}),i.publish(l.LLM_RESPONSE,{content:"",fullContent:t,done:!0}),console.log(`[LLMController] Response complete (${t.length} chars)`)}catch(o){console.error("[LLMController] Chat error:",o),i.publish(l.LLM_ERROR,{error:o.message,phase:"chat"})}finally{this.isGenerating=!1}}static cancelGeneration(){if(!this.isGenerating||!this.engine){console.warn("[LLMController] Nothing to cancel");return}console.log("[LLMController] Cancelling generation...");try{this.engine.interruptGenerate(),this.isGenerating=!1,console.log("[LLMController] Generation cancelled")}catch(e){console.error("[LLMController] Cancel failed:",e)}}static getStatus(){return{modelId:this.DEFAULT_MODEL,isLoaded:!!this.currentModel,isCached:this.isModelCached,isGenerating:this.isGenerating,messageCount:this.messages.length}}static resetConversation(){this.messages=[{role:"system",content:"You are a helpful AI assistant running locally in the browser using WebLLM. Be concise and helpful."}],console.log("[LLMController] Conversation reset")}}class ge{static _initialized=!1;static _debug=!1;static init(e={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=e.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const n=t=>{this._handleSSEMessage(t)};return window.mvvSSEther.onmessage(n),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(e){try{this._debug&&console.log("[MachVive] SSE message received:",e);const n=e?.data;if(!n){this._debug&&console.log("[MachVive] No data in message, skipping");return}const t=n.data||n.package||n;if(!t){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=t.cfg;const r=t.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",r)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(c){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:c.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const s=o?.topic;if(!s){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",s),!this._isValidTopic(s)){console.warn(`[MachVive] Topic '${s}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(s,r,e,n)}catch(n){console.error("[MachVive] Error handling SSE message:",n)}}static _isValidTopic(e){return!l||!l.hasOwnProperty(e)?(console.warn(`[MachVive] Topic '${e}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(e,n,t,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const r=window.PubSub||PubSub,s={message:n,metadata:{source:"sse",sseEventId:t.id,timestamp:t.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${e}':`,s);const c=l[e];console.log(`[MachVive] AppBroadcast.${e} = '${c}'`),r.publish(c,s),console.log(`[MachVive] ✓ Published SSE message to topic: ${e}`)}catch(r){console.error(`[MachVive] Error publishing to topic '${e}':`,r)}}static debug(e){return this._debug=e,console.log(`[MachVive] Debug mode ${e?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=ge);typeof window<"u"&&(window.MachVive=ge);kt(i,{app:"client-saas"});window.m5t=Object.create(null);window.m5t.pubsub=i;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(a){console.log("mvvLegit (direct): ReferenceError -",a.message)}const Dt=Object.keys(window).filter(a=>a.toLowerCase().includes("mvv")||a.toLowerCase().includes("neodigm")||a.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Dt);const I=new St("/",{hash:!0});window.router=I;function pe(a){const e=a?`${a.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${a} -> ${e}`),mvvLegit.isRouteAllowed(e)?!0:(console.warn(`[Router] Access denied to route: ${e}`),i.publish(l.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function $(a){console.log("[Router] Navigating to:",a),I.navigate(`/${a}`)}I.on("/",()=>{console.log("[Router] Route: /"),i.publish(l.ROUTE_NAV_BEFORE,{route:"splash"}),k(()=>Promise.resolve().then(()=>He),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"splash",error:a})})});I.on("/splash",()=>{console.log("[Router] Route: /splash"),i.publish(l.ROUTE_NAV_BEFORE,{route:"splash"}),k(()=>Promise.resolve().then(()=>He),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"splash",error:a})})});I.on("/signin",()=>{console.log("[Router] Route: /signin"),i.publish(l.ROUTE_NAV_BEFORE,{route:"signin"}),k(()=>Promise.resolve().then(()=>Kt),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"signin"})}).catch(a=>{console.error("[Router] Error loading signin route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"signin",error:a})})});I.on("/signup",()=>{console.log("[Router] Route: /signup"),i.publish(l.ROUTE_NAV_BEFORE,{route:"signup"}),k(()=>Promise.resolve().then(()=>tn),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"signup"})}).catch(a=>{console.error("[Router] Error loading signup route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"signup",error:a})})});I.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),i.publish(l.ROUTE_NAV_BEFORE,{route:"verf-link"}),k(()=>Promise.resolve().then(()=>on),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(a=>{console.error("[Router] Error loading verf-link route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"verf-link",error:a})})});I.on("/forgot",()=>{console.log("[Router] Route: /forgot"),i.publish(l.ROUTE_NAV_BEFORE,{route:"forgot"}),k(()=>Promise.resolve().then(()=>pn),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(a=>{console.error("[Router] Error loading forgot route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"forgot",error:a})})});I.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!pe("resethash")){$("signin");return}i.publish(l.ROUTE_NAV_BEFORE,{route:"resethash"}),k(()=>Promise.resolve().then(()=>hn),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(a=>{console.error("[Router] Error loading resethash route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"resethash",error:a})})});I.on("/home",()=>{if(console.log("[Router] Route: /home"),!pe("home")){$("signin");return}i.publish(l.ROUTE_NAV_BEFORE,{route:"home"}),k(()=>Promise.resolve().then(()=>Rn),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"home"})}).catch(a=>{console.error("[Router] Error loading home route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"home",error:a})})});I.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!pe("signout")){$("signin");return}i.publish(l.ROUTE_NAV_BEFORE,{route:"signout"}),k(()=>Promise.resolve().then(()=>kn),void 0).then(a=>{const e=document.getElementById("app");e.innerHTML=a.render(),a.init&&a.init(),i.publish(l.ROUTE_NAV_AFTER,{route:"signout"})}).catch(a=>{console.error("[Router] Error loading signout route:",a),i.publish(l.ROUTE_NAV_ERROR,{route:"signout",error:a})})});I.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),$("splash")});i.subscribe(l.ROUTE_NAV,(a,e)=>{console.log("[Router] ROUTE_NAV event received:",e),e?.route&&$(e.route)});function Le(){console.log("[App] Waiting for Neodigm 55 library...");let a=0;const e=100,n=setInterval(()=>{a++,a%10===0&&console.log(`[App] Still waiting... attempt ${a}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${a*100}ms`),clearInterval(n),xt()):a>=e&&(clearInterval(n),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,i.publish(l.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Le):Le();async function xt(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Ft(),x.initialize(),console.log("[App] I18n Controller initialized"),Ce.initialize().then(n=>{n?console.log("[App] LLM Controller initialized successfully"):console.warn("[App] LLM Controller initialization failed (non-critical)")}).catch(n=>{console.error("[App] LLM Controller initialization error:",n)}),!await D.init({BASE_URL:"https://streamsyncengage-saas.onrender.com",navigateFunction:n=>{console.log("[AuthController] Navigation requested:",n),$(n)}})){console.error("[App] AuthController initialization failed");return}const e=D.getEntity();e&&(console.log("[App] Session restored for:",e.email),i.publish(l.APP_USER_LOADED,{entity:e})),i.publish(l.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),I.resolve(),window.AuthController=D,window.I18nController=x,window.LLMController=Ce,window.MachVive=ge,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, LLMController, MachVive available globally)")}i.subscribe(l.ROUTE_NAV_AFTER,(a,e)=>{typeof x<"u"&&x.refresh&&setTimeout(()=>{x.refresh()},100)});const Gt=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function Oe(a){return Gt[a]||null}class Ht{static MIN_ROLE_VALUE=50;static COMMANDS={help:"Show available commands",clear:"Clear chat canvas",debug:"Toggle debug mode (::debug on|off)",version:"Show application version",feature:"Feature flag operations (::feature list|get|set)",model:"LLM model operations (::model status|download|clear)",reload:"Reload the page",export:"Export chat history as JSON",theme:"Toggle theme (::theme dark|light)",auth:"Show authentication status"};static hasAccess(e){if(!e||!e.class)return!1;let n=0;if(typeof e.class=="string"){const t=Oe(e.class);n=t?t.value:0}else typeof e.class=="object"&&e.class.value!==void 0&&(n=e.class.value);return console.log(`[CLIController] Role check: ${e.class} → value: ${n}`),n>=this.MIN_ROLE_VALUE}static async process(e,n){if(!this.hasAccess(n))return{error:!0,message:`⛔ **Access Denied**

CLI commands require admin privileges (role ≥ 50).`};const t=e.slice(2).trim(),[o,...r]=t.split(/\s+/);switch(console.log("[CLIController] Processing command:",o,"Args:",r),o.toLowerCase()){case"help":return this.cmdHelp();case"clear":return this.cmdClear();case"debug":return this.cmdDebug(r);case"version":return this.cmdVersion();case"feature":return this.cmdFeature(r);case"model":return this.cmdModel(r);case"reload":return this.cmdReload();case"export":return this.cmdExport();case"theme":return this.cmdTheme(r);case"auth":return this.cmdAuth(n);default:return{error:!0,message:`❌ **Unknown command:** \`${o}\`

Type \`::help\` for available commands.`}}}static cmdHelp(){let e=`📖 **CLI Commands**

`;e+="Available commands (prefix with `::`)\n\n";for(const[n,t]of Object.entries(this.COMMANDS))e+=`• \`::${n}\` - ${t}
`;return e+=`
**Examples:**
...
Usage: \`::debug on|off\``};const t=n==="on";return localStorage.setItem("debug_mode",t),{message:`🐛 Debug mode ${t?"**enabled**":"**disabled**"}`}}static cmdVersion(){return{message:`ℹ️ **StreamSyncEngage SaaS Client**

Version: 1.0.0
Build: production
Node Env: production`}}static cmdFeature(e){const n=e[0]?.toLowerCase();if(!n)return{message:"🚩 **Feature Flags**\n\nUsage:\n• `::feature list` - List all flags\n• `::feature get <name>` - Get flag value\n• `::feature set <name> <value>` - Set flag value"};switch(n){case"list":{let t=`🚩 **Feature Flags**

`;const o=Object.entries(S).slice(0,20);for(const[r,s]of o)t+=`• \`${r}\`: \`${s}\`
`;return t+=`
*Showing 20 of ${Object.keys(S).length} flags*`,{message:t}}case"get":{const t=e[1];if(!t)return{error:!0,message:"❌ Flag name required: `::feature get <name>`"};const o=S[t];return o===void 0?{error:!0,message:`❌ Flag not found: \`${t}\``}:{message:`🚩 \`${t}\` = \`${o}\``}}case"set":return{message:`⚠️ **Feature flag modification**

Setting flags dynamically is not yet implemented.
Flags are loaded from \`featureFlags.js\`.`};default:return{error:!0,message:`❌ Unknown action: \`${n}\``}}}static cmdModel(e){const n=e[0]?.toLowerCase();if(!n)return{message:"🤖 **LLM Model Operations**\n\nUsage:\n• `::model status` - Show model status\n• `::model download` - Download model\n• `::model clear` - Clear model cache"};switch(n){case"status":{if(!window.LLMController)return{error:!0,message:"❌ LLMController not available"};const t=window.LLMController.getStatus();let o=`🤖 **LLM Model Status**

`;return o+=`• Model: \`${t.modelId}\`
`,o+=`• Loaded: \`${t.isLoaded?"YES":"NO"}\`
`,o+=`• Cached: \`${t.isCached?"YES":"NO"}\`
`,o+=`• Generating: \`${t.isGenerating?"YES":"NO"}\`
`,o+=`• Message Count: \`${t.messageCount}\`
...
3. Delete \`webllm/model\``};default:return{error:!0,message:`❌ Unknown action: \`${n}\``}}}static cmdReload(){return setTimeout(()=>{window.location.reload()},500),{message:"🔄 Reloading page..."}}static cmdExport(){const e=document.getElementById("chat-messages");if(!e)return{error:!0,message:"❌ Chat canvas not found"};const t=Array.from(e.children).map(p=>({type:p.tagName.toLowerCase().includes("prompt")?"user":"assistant",message:p.getAttribute("message"),timestamp:p.getAttribute("timestamp")})),o=JSON.stringify(t,null,2),r=new Blob([o],{type:"application/json"}),s=URL.createObjectURL(r),c=document.createElement("a");return c.href=s,c.download=`chat-export-${Date.now()}.json`,c.click(),URL.revokeObjectURL(s),{message:`✅ Exported ${t.length} messages`}}static cmdTheme(e){const n=e[0]?.toLowerCase();return!n||!["dark","light"].includes(n)?{message:"🎨 **Theme Toggle**\n\nUsage: `::theme dark|light`"}:(localStorage.setItem("theme",n),{message:`🎨 Theme set to **${n}**

⚠️ Theme switching not yet implemented in UI.`})}static cmdAuth(e){if(!e)return{error:!0,message:"❌ Not authenticated"};let n="Unknown",t=0;if(typeof e.class=="string"){const r=Oe(e.class);r&&(n=r.desc,t=r.value)}else typeof e.class=="object"&&(n=e.class.desc||"Unknown",t=e.class.value||0);let o=`🔐 **Authentication Status**
...
`,{message:o}}}const Vt=Object.freeze(Object.defineProperty({__proto__:null,default:Ht},Symbol.toStringTag,{value:"Module"}));function Bt(){return`
  ...
  `}function $t(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const a=localStorage.getItem(S.FF_SSE_LS_TOKEN),e=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!a,hasMvvTs:!!e});const n=document.getElementById("splash-loader"),t=document.getElementById("splash-actions");a?(console.log("[SplashRoute] Auth token found → HOME"),i.publish(l.ROUTE_NAV,{route:"home"})):e?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),i.publish(l.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),n&&(n.style.display="none"),t&&(t.style.display="flex"),document.querySelectorAll("[data-route]").forEach(r=>{r.addEventListener("click",()=>{const s=r.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${s}`),i.publish(l.ROUTE_NAV,{route:s})})}))},4e3)}const He=Object.freeze(Object.defineProperty({__proto__:null,init:$t,render:Bt},Symbol.toStringTag,{value:"Module"}));function _e(a){return a=String(a),Math.abs(a.split("").reduce((e,n)=>(e<<5)-e+n.charCodeAt(0)|0,0))}function qt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function zt(){console.log("[SigninRoute] Initialized");const a=document.getElementById("loginForm"),e=document.getElementById("email"),n=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const r=n.type==="password"?"text":"password";n.type=r}),a?.addEventListener("submit",async r=>{r.preventDefault();const s=e.value.trim(),c=n.value;jt(s,e)&&Yt(c,n)&&await Wt(s,c)}),document.getElementById("link--uc__underline")?.addEventListener("click",r=>{r.preventDefault(),i.publish(l.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",r=>{r.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),i.publish(l.ROUTE_NAV,{route:"signup"})})}function jt(a,e){if(!a)return ee(e,m.get("validation_email_required")),!1;const n=(a.match(/@/g)||[]).length,t=(a.match(/\./g)||[]).length;return n!==1||t<1?(ee(e,m.get("validation_email_invalid")),!1):!0}function Yt(a,e){return a?a.length<10?(ee(e,m.get("validation_password_min_length")),!1):!0:(ee(e,m.get("validation_password_required")),!1)}function ee(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function Wt(a,e){const n=document.querySelector(".btn");n.disabled=!0,n.textContent=m.get("loading_signing_in");try{const t=_e(e),o=await D.doSignin(a,t);o.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(m.get("success_welcome_back"),"success"),i.publish(l.AUTH_SIGNIN_SUCCESS,{entity:D.getEntity()})):o.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(m.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(o.error||m.get("error_signin_failed"),"danger"),n.disabled=!1,n.textContent=m.get("sign_in").toUpperCase())}catch(t){console.error("[SigninRoute] Sign in error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||m.get("error_network"),"danger"),n.disabled=!1,n.textContent=m.get("sign_in").toUpperCase(),i.publish(l.AUTH_SIGNIN_FAIL,{message:t.message})}}const Kt=Object.freeze(Object.defineProperty({__proto__:null,init:zt,render:qt},Symbol.toStringTag,{value:"Module"}));function Ve(a){const e=[];return a.length<10&&e.push("at least 10 characters"),/[a-z]/.test(a)||e.push("1 lowercase"),/[A-Z]/.test(a)||e.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(a)||e.push("1 special character"),/[^\x00-\x7F]/.test(a)&&e.push("ASCII characters only"),e}function Be(a){return a.length===0?"":a.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":a.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}function Jt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Qt(){console.log("[SignupRoute] Initialized");const a=document.getElementById("signupForm"),e=a.querySelector('button[type="submit"]');Re("togglePassword","password","eyeIcon"),Re("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",t=>{t.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),i.publish(l.ROUTE_NAV,{route:"signin"})}),a.addEventListener("submit",async t=>{t.preventDefault();const o=document.getElementById("first").value.trim(),r=document.getElementById("last").value.trim(),s=document.getElementById("email").value.trim(),c=document.getElementById("company").value.trim(),p=document.getElementById("phone").value.trim(),_=document.getElementById("password").value,v=document.getElementById("confirmPassword").value,w=document.getElementById("first"),y=document.getElementById("last"),C=document.getElementById("email"),R=document.getElementById("password"),u=document.getElementById("confirmPassword");if(Ne(o,w,m.get("validation_first_name_required"))&&Ne(r,y,m.get("validation_last_name_required"))&&Xt(s,C)&&Zt(_,R)){if(_!==v){B(u,m.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=m.get("loading_creating_account"),await en(o,r,s,c,p,_)}})}function Re(a,e,n){const t=document.getElementById(a),o=document.getElementById(e),r=document.getElementById(n);!t||!o||!r||t.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Ne(a,e,n){return a?!0:(B(e,n),!1)}function Xt(a,e){if(!a)return B(e,m.get("validation_email_required")),!1;const n=(a.match(/@/g)||[]).length,t=(a.match(/\./g)||[]).length;return n!==1||t<1?(B(e,m.get("validation_email_invalid")),!1):!0}function Zt(a,e){if(!a)return B(e,m.get("validation_password_required")),!1;const n=Ve(a);return n.length>0?(B(e,Be(n)),!1):!0}function B(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function en(a,e,n,t,o,r){const s=document.querySelector('button[type="submit"]');try{const c=_e(r),p={email:n,hash:c,first:a,last:e};t&&(p.company=t),o&&(p.phone=o);const _=await D.doSignup(p);if(_.ok)i.publish(l.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const v=_.error||_.message||m.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(v,"danger"),s.disabled=!1,s.textContent=m.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:v})}}catch(c){console.error("[SignupRoute] Sign up error:",c),typeof neodigmToast<"u"&&neodigmToast.q(c.message||m.get("error_network"),"danger"),s.disabled=!1,s.textContent=m.get("create_account").toUpperCase(),i.publish(l.AUTH_SIGNUP_FAIL,{message:c.message})}}const tn=Object.freeze(Object.defineProperty({__proto__:null,init:Qt,render:Jt},Symbol.toStringTag,{value:"Module"}));function nn(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function dn(){console.log("[ForgotRoute] Initialized");const a=document.getElementById("forgot-form"),e=document.getElementById("email");a?.addEventListener("submit",async n=>{n.preventDefault();const t=e.value.trim();un(t,e)&&await gn(t)})}function un(a,e){if(!a)return Ie(e,m.get("validation_email_required")),!1;const n=(a.match(/@/g)||[]).length,t=(a.match(/\./g)||[]).length;return n!==1||t<1?(Ie(e,m.get("validation_email_invalid")),!1):!0}function Ie(a,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${a.id}`):(a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),300)),a.focus()}async function gn(a){const e=document.querySelector(".btn");e.disabled=!0,e.textContent="SENDING...";try{const n=await ln.forgotPassword(a);n.ok&&n.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(m.get("success_reset_link_sent"),"success"),i.publish(l.AUTH_FORGOT_SUCCESS,{email:a}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(n.data.error||m.get("error_signin_failed"),"danger"),e.disabled=!1,e.textContent=m.get("send_reset_link").toUpperCase())}catch(n){console.error("[ForgotRoute] Forgot password error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||m.get("error_network"),"danger"),e.disabled=!1,e.textContent=m.get("send_reset_link").toUpperCase()}}const pn=Object.freeze(Object.defineProperty({__proto__:null,init:dn,render:cn},Symbol.toStringTag,{value:"Module"}));function _n(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function mn(){console.log("[ResethashRoute] Initialized");const a=document.getElementById("resethash-form"),e=a.querySelector('button[type="submit"]');ke("toggleNewPassword","new-password","eyeIconNew"),ke("toggleConfirmPassword","confirm-password","eyeIconConfirm"),a?.addEventListener("submit",async n=>{n.preventDefault();const t=a.email.value.trim(),o=a.newPassword.value,r=a.confirmPassword.value,s=document.getElementById("new-password"),c=document.getElementById("confirm-password");if(!o){V(s,m.get("validation_new_password_required"));return}const p=Ve(o);if(p.length>0){V(s,Be(p));return}if(!r){V(c,m.get("validation_new_password_required"));return}if(o!==r){V(c,m.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=m.get("loading_resetting_password");try{const _=_e(o),v=await D.doResetHash(t,_);v.ok?(typeof neodigmToast<"u"&&neodigmToast.q(m.get("success_password_reset"),"success"),i.publish(l.AUTH_RESETHASH_SUCCESS,{email:t})):(V(s,v.error||m.get("error_signin_failed")),e.disabled=!1,e.textContent=m.get("update_password").toUpperCase())}catch(_){console.error("[ResethashRoute] Reset password error:",_),V(s,_.message||m.get("error_network")),e.disabled=!1,e.textContent=m.get("update_password").toUpperCase()}})}function ke(a,e,n){const t=document.getElementById(a),o=document.getElementById(e),r=document.getElementById(n);!t||!o||!r||t.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
      ...
      <style>
        ...
        .nav-container {
          display: grid;
          grid-template-areas: "logo ${this.buttons.map((t,o)=>`btn${o}`).join(" ")}";
      ...
      <div class="nav-wrapper">
        <nav class="nav-container">
          ...
          ${this.buttons.map((t,o)=>this.renderButton(t,o,"primary")).join("")}
        </nav>
        <nav class="secondary-nav">
          ${n?e.map((t,o)=>this.renderButton(t,o,"secondary")).join(""):""}
        </nav>
      </div>
    `}renderButton(e,n,t="primary"){const o=t==="primary"?e.token===this.selectedPrimaryToken:!1,r=typeof e.count=="number"&&e.count!==null&&e.count!==void 0,s=e.icon&&e.icon.trim()!=="",c=e.tagline&&e.tagline.trim()!=="";return`
      <button
        ...
        ${e.enabled?"":"disabled"}
        ${c?`title="${e.tagline}"`:""}
        style="grid-area: ${t==="primary"?`btn${n}`:"auto"}"
      >
        ${s?`<i class="${e.icon} nav-button-icon"></i>`:""}
        <span>${e.caption}</span>
        ${r?`<span class="count-badge">${e.count}</span>`:""}
      </button>
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(t=>{const o=t.getAttribute("data-token"),r=t.getAttribute("data-level");t.addEventListener("click",s=>{o&&!s.currentTarget.disabled&&!this.longTapFired&&(r==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),t.addEventListener("dblclick",s=>{if(o&&!s.currentTarget.disabled){const c=this.getButtonData(o,r);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:r,caption:c.caption,tagline:c.tagline,timestamp:Date.now()}}))}}),t.addEventListener("mouseenter",s=>{if(o&&!s.currentTarget.disabled){const c=this.getButtonData(o,r);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:r,caption:c.caption,tagline:c.tagline,action:"enter",timestamp:Date.now()}}))}}),t.addEventListener("mouseleave",s=>{if(o&&!s.currentTarget.disabled){const c=this.getButtonData(o,r);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:r,caption:c.caption,tagline:c.tagline,action:"leave",timestamp:Date.now()}}))}}),t.addEventListener("mousedown",s=>{o&&!s.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const c=this.getButtonData(o,r);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:r,caption:c.caption,tagline:c.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),t.addEventListener("mouseup",s=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),t.addEventListener("mouseleave",s=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const n=this.shadowRoot.querySelector(".logo");n&&n.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(e){const n=this.buttons.find(o=>o.token===e),t=this.getButtonData(e,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:e,level:"primary",caption:t.caption,tagline:t.tagline,hasSecondary:(n?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==e&&(this.selectedPrimaryToken=e,this.render(),this.attachEventListeners())}selectSecondaryButton(e){const n=this.getButtonData(e,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:e,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:n.caption,tagline:n.tagline,timestamp:Date.now()}}))}updateButtons(e){this.setAttribute("data-buttons",JSON.stringify(e)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(e,n,t="primary"){let o;t==="primary"?o=this.buttons.find(r=>r.token===e):o=this.getSecondaryButtons().find(s=>s.token===e),o&&(o.count=n,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",fn);class vn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["message","timestamp","show-timestamp"]}attributeChangedCallback(e,n,t){n!==t&&this.render()}getMessage(){return this.getAttribute("message")||""}getTimestamp(){const e=this.getAttribute("timestamp");return e||new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}shouldShowTimestamp(){return this.getAttribute("show-timestamp")!=="false"}escapeHtml(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}render(){const e=this.getMessage(),n=this.getTimestamp(),t=this.shouldShowTimestamp();this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
          flex-direction: column;
      ...
      ${t?`<div class="bubble-timestamp">${this.escapeHtml(n)}</div>`:""}
    `}}customElements.define("m5t-chat-prompt",vn);let J=null,ie=null;async function bn(){return J||(ie||(ie=k(()=>import("https://cdn.jsdelivr.net/npm/markdown-it@14.1.0/+esm"),[]).then(a=>{const e=a.default;return J=e({html:!1,breaks:!0,linkify:!0,typographer:!0}),J})),ie)}class En extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["message","timestamp","show-timestamp","avatar","show-avatar"]}attributeChangedCallback(e,n,t){n!==t&&this.render()}getMessage(){return this.getAttribute("message")||""}getTimestamp(){const e=this.getAttribute("timestamp");return e||new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}shouldShowTimestamp(){return this.getAttribute("show-timestamp")!=="false"}getAvatar(){return this.getAttribute("avatar")||""}shouldShowAvatar(){return this.getAttribute("show-avatar")==="true"&&this.getAvatar()}escapeHtml(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}async renderMarkdown(e){return(await bn()).render(e)}async render(){const e=this.getMessage(),n=this.getTimestamp(),t=this.shouldShowTimestamp(),o=this.getAvatar(),r=this.shouldShowAvatar(),s=await this.renderMarkdown(e);this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
          flex-direction: column;
    ...
    `}}customElements.define("m5t-chat-response",En);class yn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.attachEventListeners()}getPlaceholder(){return this.getAttribute("placeholder")||"Type your message..."}getMaxRows(){return parseInt(this.getAttribute("max-rows"))||5}render(){const e=this.getPlaceholder(),n=this.getMaxRows();this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    `}attachEventListeners(){const e=this.shadowRoot.getElementById("prompt-textarea"),n=this.shadowRoot.getElementById("send-btn"),t=this.shadowRoot.getElementById("cancel-btn");!e||!n||!t||(e.addEventListener("input",()=>{this.autoExpandTextarea(e)}),e.addEventListener("keydown",o=>{o.key==="Enter"&&!o.shiftKey&&(o.preventDefault(),this.handleSend())}),n.addEventListener("click",()=>{this.handleSend()}),t.addEventListener("click",()=>{this.handleCancel()}))}autoExpandTextarea(e){e.style.height="auto",e.style.height=e.scrollHeight+"px"}handleSend(){const e=this.shadowRoot.getElementById("prompt-textarea");if(!e)return;const n=e.value.trim();if(!n){console.warn("[M5TChatPromptArea] Cannot send empty message");return}const t=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),o={message:n,timestamp:t,pubsubTopic:"CONVERSATION.PROMPT.AGENT_CANVAS"};console.log("[M5TChatPromptArea] Dispatching message-sent event:",o),e.value="",e.style.height="auto",this.dispatchEvent(new CustomEvent("message-sent",{bubbles:!0,composed:!0,detail:o}))}handleCancel(){const e=this.shadowRoot.getElementById("prompt-textarea");e&&(e.value="",e.style.height="auto",console.log("[M5TChatPromptArea] Input cancelled"),this.dispatchEvent(new CustomEvent("message-cancelled",{bubbles:!0,composed:!0})))}getMessage(){const e=this.shadowRoot.getElementById("prompt-textarea");return e?e.value:""}setMessage(e){const n=this.shadowRoot.getElementById("prompt-textarea");n&&(n.value=e,this.autoExpandTextarea(n))}clear(){this.handleCancel()}focus(){const e=this.shadowRoot.getElementById("prompt-textarea");e&&e.focus()}}customElements.define("m5t-chat-prompt-area",yn);te.setAppToken("client-saas");function Sn(){return`
  ...
  `}function An(){console.log("[HomeRoute] Initialized"),i.subscribe(l.CANVAS_DO_SCROLL,(a,e)=>{console.log("[HomeRoute] CANVAS.DO.SCROLL triggered"),wn()}),i.subscribe(l.LLM_STATUS,(a,e)=>{if(console.log("[HomeRoute] LLM_STATUS:",e),e&&e.text){const n=`🔄 ${e.text}`;i.publish(l.CONVERSATION_RESPONSE_CANVAS,{message:n,timestamp:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),streaming:!0})}})}function wn(){setTimeout(()=>{const a=document.getElementById("chat-messages");a?(a.scrollTo({top:0,behavior:"smooth"}),console.log("[HomeRoute] Scrolled chat-messages to bottom (top: 0 with column-reverse)")):console.warn("[HomeRoute] chat-messages element not found")},80)}function me(a,e="user",n="canvas"){const t=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),o={message:a,timestamp:t};if(e==="user"||e==="prompt")switch(n.toUpperCase()){case"CANVAS":i.publish(l.CONVERSATION_PROMPT_CANVAS,o);break;case"AGENT":i.publish(l.CONVERSATION_PROMPT_AGENT,o);break;case"AGENT_CANVAS":i.publish(l.CONVERSATION_PROMPT_AGENT_CANVAS,o);break;case"STAGE":i.publish(l.CONVERSATION_PROMPT_STAGE,o);break;default:i.publish(l.CONVERSATION_PROMPT_CANVAS,o)}else switch(n.toUpperCase()){case"CANVAS":i.publish(l.CONVERSATION_RESPONSE_CANVAS,o);break;case"WORKFLOW":i.publish(l.CONVERSATION_RESPONSE_WORKFLOW,o);break;default:i.publish(l.CONVERSATION_RESPONSE_CANVAS,o)}}function Tn(a=10,e=500){const n=["Hey, how's it going?","Can you help me with something?","What's the weather like today?","I need assistance with my account","Tell me a joke!","How do I reset my password?","What are your hours?","Thanks for your help!","I have a question about billing","Can you explain this feature?","How do I upgrade my plan?","What's new in the latest update?","I'm having trouble logging in","Where can I find the settings?","How secure is my data?","Do you offer customer support?","What payment methods do you accept?","Can I cancel my subscription?","How do I export my data?","Is there a mobile app?"],t=["I'm doing great! How can I help you today?","Of course! I'd be happy to assist you.","Let me check that for you...","Here's what I found:","That's a great question!","I can help you with that.","Let me walk you through the steps.","You're very welcome!","I understand your concern. Let me explain...","That feature is located in the settings menu.","Your account is fully secured with encryption.","We're available 24/7 to help you!","We accept all major credit cards and PayPal.","You can upgrade anytime from your account settings.","The latest update includes several new features!","Try resetting your password using the forgot password link.","Your data is encrypted and stored securely.","Yes! Our mobile app is available for iOS and Android.","You can export your data from the account settings.","Absolutely! You can cancel anytime with no fees."];let o=0;const r=setInterval(()=>{if(o>=a){clearInterval(r),console.log(`[Test] Generated ${a} random bubbles`);return}const s=Math.random()>.5,c=s?"user":"assistant",p=s?n:t,_=p[Math.floor(Math.random()*p.length)];me(_,c),o++,console.log(`[Test] Added bubble ${o}/${a} (${c})`)},e)}let Y=null;function Cn(a=1e3){if(Y){console.log("[Test] Bubble stream already running. Stop it first with stopBubbleStream()");return}console.log("[Test] Starting continuous bubble stream..."),Y=setInterval(()=>{const e=Math.random()>.5,n=e?["Quick message!","Another one!","Test bubble","Hello there!","Random user text"]:["Response here","Got it!","Processing...","Here's the answer","Understood!"],t=n[Math.floor(Math.random()*n.length)];me(t,e?"user":"assistant")},a)}function Ln(){Y?(clearInterval(Y),Y=null,console.log("[Test] Bubble stream stopped")):console.log("[Test] No bubble stream running")}function On(){const a=document.getElementById("chat-messages");a&&(a.innerHTML="",console.log("[Test] All bubbles cleared"))}window.addChatBubble=me;window.generateRandomBubbles=Tn;window.startBubbleStream=Cn;window.stopBubbleStream=Ln;window.clearAllBubbles=On;console.log("[HomeRoute] Test functions available:");console.log("  - window.generateRandomBubbles(count, delay) - Generate N bubbles with delay");console.log("  - window.startBubbleStream(delayMs) - Continuous bubble generation");console.log("  - window.stopBubbleStream() - Stop continuous generation");console.log("  - window.clearAllBubbles() - Remove all bubbles");console.log("  - window.addChatBubble(message, type) - Add single bubble");const Rn=Object.freeze(Object.defineProperty({__proto__:null,init:An,render:Sn},Symbol.toStringTag,{value:"Module"}));function Nn(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function In(){console.log("[SignoutRoute] Initialized");const a=document.getElementById("confirm-signout-btn");a?.addEventListener("click",async()=>{a.disabled=!0,a.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await D.doSignout()})}const kn=Object.freeze(Object.defineProperty({__proto__:null,init:In,render:Nn},Symbol.toStringTag,{value:"Module"}));

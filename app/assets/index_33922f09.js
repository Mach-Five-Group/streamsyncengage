(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const Ye="modulepreload",je=function(t){return"/"+t},he={},M=function(e,n,a){let o=Promise.resolve();if(n&&n.length>0){let h=function(m){return Promise.all(m.map(E=>Promise.resolve(E).then(I=>({status:"fulfilled",value:I}),I=>({status:"rejected",reason:I}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),d=s?.nonce||s?.getAttribute("nonce");o=h(n.map(m=>{if(m=je(m),m in he)return;he[m]=!0;const E=m.endsWith(".css"),I=E?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${I}`))return;const w=document.createElement("link");if(w.rel=E?"stylesheet":Ye,E||(w.as="script"),w.crossOrigin="",w.href=m,d&&w.setAttribute("nonce",d),document.head.appendChild(w),E)return new Promise((C,x)=>{w.addEventListener("load",C),w.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${m}`)))})}))}function r(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return o.then(s=>{for(const d of s||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};var We=/([:*])(\w+)/g,Ke="([^/]+)",Je=/\*/g,Qe="?(?:.*)",Xe=/\/\?/g,Ze="/?([^/]+|)",et="(?:/^|^)",tt="";function Re(t){return t===void 0&&(t="/"),ce()?location.pathname+location.search+location.hash:t}function A(t){return t.replace(/\/+$/,"").replace(/^\/+/,"")}function K(t){return typeof t=="string"}function nt(t){return typeof t=="function"}function J(t){return t&&t.indexOf("#")>=0&&t.split("#").pop()||""}function at(t,e){return e.length===0||!t?null:t.slice(1,t.length).reduce(function(n,a,o){return n===null&&(n={}),n[e[o]]=decodeURIComponent(a),n},null)}function Q(t){var e=A(t).split(/\?(.*)?$/);return[A(e[0]),e.slice(1).join("")]}function le(t){for(var e={},n=t.split("&"),a=0;a<n.length;a++){var o=n[a].split("=");if(o[0]!==""){var r=decodeURIComponent(o[0]);e[r]?(Array.isArray(e[r])||(e[r]=[e[r]]),e[r].push(decodeURIComponent(o[1]||""))):e[r]=decodeURIComponent(o[1]||"")}}return e}function Oe(t,e){var n=Q(A(t.currentLocationPath)),a=n[0],o=n[1],r=o===""?null:le(o),s=[],d;if(K(e.path)){if(d=et+A(e.path).replace(We,function(I,w,C){return s.push(C),Ke}).replace(Je,Qe).replace(Xe,Ze)+"$",A(e.path)===""&&A(a)==="")return{url:a,queryString:o,hashString:J(t.to),route:e,data:null,params:r}}else d=e.path;var h=new RegExp(d,tt),m=a.match(h);if(m){var E=K(e.path)?at(m,s):m.groups?m.groups:m.slice(1);return{url:A(a.replace(new RegExp("^"+t.instance.root),"")),queryString:o,hashString:J(t.to),route:e,data:E,params:r}}return!1}function Ce(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function H(t,e){return typeof t[e]>"u"||t[e]===!0}function ot(t){if(!t)return{};var e=t.split(","),n={},a;return e.forEach(function(o){var r=o.split(":").map(function(s){return s.replace(/(^ +| +$)/g,"")});switch(r[0]){case"historyAPIMethod":n.historyAPIMethod=r[1];break;case"resolveOptionsStrategy":a||(a={}),a.strategy=r[1];break;case"resolveOptionsHash":a||(a={}),a.hash=r[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":n[r[0]]=r[1]==="true";break}}),a&&(n.resolveOptions=a),n}function ce(){return typeof window<"u"}function rt(t,e){return t===void 0&&(t=[]),e===void 0&&(e={}),t.filter(function(n){return n}).forEach(function(n){["before","after","already","leave"].forEach(function(a){n[a]&&(e[a]||(e[a]=[]),e[a].push(n[a]))})}),e}function L(t,e,n){var a=e||{},o=0;(function r(){if(!t[o]){n&&n(a);return}Array.isArray(t[o])?(t.splice.apply(t,[o,1].concat(t[o][0](a)?t[o][1]:t[o][2])),r()):t[o](a,function(s){typeof s>"u"||s===!0?(o+=1,r()):n&&n(a)})})()}L.if=function(t,e,n){return Array.isArray(e)||(e=[e]),Array.isArray(n)||(n=[n]),[t,e,n]};function fe(t,e){typeof t.currentLocationPath>"u"&&(t.currentLocationPath=t.to=Re(t.instance.root)),t.currentLocationPath=t.instance._checkForAHash(t.currentLocationPath),e()}function te(t,e){for(var n=0;n<t.instance.routes.length;n++){var a=t.instance.routes[n],o=Oe(t,a);if(o&&(t.matches||(t.matches=[]),t.matches.push(o),t.resolveOptions.strategy==="ONE")){e();return}}e()}function st(t,e){t.navigateOptions&&(typeof t.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof t.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),e()}function it(t,e){t.navigateOptions.force===!0?(t.instance._setCurrent([t.instance._pathToMatchObject(t.to)]),e(!1)):e()}var ve=ce(),lt=Ce();function ct(t,e){if(H(t.navigateOptions,"updateBrowserURL")){var n=("/"+t.to).replace(/\/\//g,"/"),a=ve&&t.resolveOptions&&t.resolveOptions.hash===!0;lt?(history[t.navigateOptions.historyAPIMethod||"pushState"](t.navigateOptions.stateObj||{},t.navigateOptions.title||"",a?"#"+n:n),location&&location.hash&&(t.instance.__freezeListening=!0,setTimeout(function(){if(!a){var o=location.hash;location.hash="",location.hash=o}t.instance.__freezeListening=!1},1))):ve&&(window.location.href=t.to)}e()}function ke(t,e){var n=t.instance;if(!n.lastResolved()){e();return}L(n.lastResolved().map(function(a){return function(o,r){if(!a.route.hooks||!a.route.hooks.leave){r();return}var s=!1,d=t.instance.matchLocation(a.route.path,t.currentLocationPath,!1);if(a.route.path!=="*")s=!d;else{var h=t.matches?t.matches.find(function(m){return a.route.path===m.route.path}):!1;s=!h}if(H(t.navigateOptions,"callHooks")&&s){L(a.route.hooks.leave.map(function(m){return function(E,I){return m(function(w){w===!1?t.instance.__markAsClean(t):I()},t.matches&&t.matches.length>0?t.matches.length===1?t.matches[0]:t.matches:void 0)}}).concat([function(){return r()}]));return}else r()}}),{},function(){return e()})}function dt(t,e){t.match.route.hooks&&t.match.route.hooks.before&&H(t.navigateOptions,"callHooks")?L(t.match.route.hooks.before.map(function(n){return function(o,r){return n(function(s){s===!1?t.instance.__markAsClean(t):r()},t.match)}}).concat([function(){return e()}])):e()}function ut(t,e){H(t.navigateOptions,"callHandler")&&t.match.route.handler(t.match),t.instance.updatePageLinks(),e()}function pt(t,e){t.match.route.hooks&&t.match.route.hooks.after&&H(t.navigateOptions,"callHooks")&&t.match.route.hooks.after.forEach(function(n){return n(t.match)}),e()}function gt(t,e){var n=t.instance.lastResolved();if(n&&n[0]&&n[0].route===t.match.route&&n[0].url===t.match.url&&n[0].queryString===t.match.queryString){n.forEach(function(a){a.route.hooks&&a.route.hooks.already&&H(t.navigateOptions,"callHooks")&&a.route.hooks.already.forEach(function(o){return o(t.match)})}),e(!1);return}e()}function _t(t,e){var n=t.instance._notFoundRoute;if(n){t.notFoundHandled=!0;var a=Q(t.currentLocationPath),o=a[0],r=a[1],s=J(t.to);n.path=A(o);var d={url:n.path,queryString:r,hashString:s,data:null,route:n,params:r!==""?le(r):null};t.matches=[d],t.match=d}e()}function mt(t,e){(!t.resolveOptions||t.resolveOptions.noMatchWarning===!1||typeof t.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+t.currentLocationPath+`" didn't match any of the registered routes.`),e()}function ht(t,e){t.instance._setCurrent(null),e()}function Pe(t,e){H(t.navigateOptions,"updateState")&&t.instance._setCurrent(t.matches),e()}var Le=[gt,dt,ut,pt],be=[ke,_t,L.if(function(t){var e=t.notFoundHandled;return e},Le.concat([Pe]),[mt,ht])];function se(){return se=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(t[a]=n[a])}return t},se.apply(this,arguments)}function Ee(t,e){var n=0;function a(){if(n===t.matches.length){Pe(t,e);return}L(Le,se({},t,{match:t.matches[n]}),function(){n+=1,a()})}ke(t,a)}function ne(t){t.instance.__markAsClean(t)}function ie(){return ie=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(t[a]=n[a])}return t},ie.apply(this,arguments)}var ye="[data-navigo]";function ft(t,e){var n=e||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:ye},a=this,o="/",r=null,s=[],d=!1,h,m=Ce(),E=ce();t?o=A(t):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function I(l){return l.indexOf("#")>=0&&(n.hash===!0?l=l.split("#")[1]||"/":l=l.split("#")[0]),l}function w(l){return A(o+"/"+A(l))}function C(l,p,v,y){return l=K(l)?w(l):l,{name:y||A(String(l)),path:l,handler:p,hooks:rt(v)}}function x(l,p,v){var y=this;return typeof l=="object"&&!(l instanceof RegExp)?(Object.keys(l).forEach(function(b){if(typeof l[b]=="function")y.on(b,l[b]);else{var P=l[b],z=P.uses,qe=P.as,ze=P.hooks;s.push(C(b,z,[h,ze],qe))}}),this):(typeof l=="function"&&(v=p,p=l,l=o),s.push(C(l,p,[h,v])),this)}function u(l,p){if(a.__dirty){a.__waiting.push(function(){return a.resolve(l,p)});return}else a.__dirty=!0;l=l?A(o)+"/"+A(l):void 0;var v={instance:a,to:l,currentLocationPath:l,navigateOptions:{},resolveOptions:ie({},n,p)};return L([fe,te,L.if(function(y){var b=y.matches;return b&&b.length>0},Ee,be)],v,ne),v.matches?v.matches:!1}function _(l,p){if(a.__dirty){a.__waiting.push(function(){return a.navigate(l,p)});return}else a.__dirty=!0;l=A(o)+"/"+A(l);var v={instance:a,to:l,navigateOptions:p||{},resolveOptions:p&&p.resolveOptions?p.resolveOptions:n,currentLocationPath:I(l)};L([st,it,te,L.if(function(y){var b=y.matches;return b&&b.length>0},Ee,be),ct,ne],v,ne)}function f(l,p,v){var y=ge(l,p);return y!==null?(_(y.replace(new RegExp("^/?"+o),""),v),!0):!1}function T(l){return this.routes=s=s.filter(function(p){return K(l)?A(p.path)!==A(l):nt(l)?l!==p.handler:String(p.path)!==String(l)}),this}function N(){m&&(this.__popstateListener=function(){a.__freezeListening||u()},window.addEventListener("popstate",this.__popstateListener))}function R(){this.routes=s=[],m&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=d=!0}function U(l,p){return a._notFoundRoute=C("*",l,[h,p],"__NOT_FOUND__"),this}function k(){if(E)return G().forEach(function(l){if(l.getAttribute("data-navigo")==="false"||l.getAttribute("target")==="_blank"){l.hasListenerAttached&&l.removeEventListener("click",l.navigoHandler);return}l.hasListenerAttached||(l.hasListenerAttached=!0,l.navigoHandler=function(p){if((p.ctrlKey||p.metaKey)&&p.target.tagName.toLowerCase()==="a")return!1;var v=l.getAttribute("href");if(typeof v>"u"||v===null)return!1;if(v.match(/^(http|https)/)&&typeof URL<"u")try{var y=new URL(v);v=y.pathname+y.search}catch{}var b=ot(l.getAttribute("data-navigo-options"));d||(p.preventDefault(),p.stopPropagation(),a.navigate(A(v),b))},l.addEventListener("click",l.navigoHandler))}),a}function G(){return E?[].slice.call(document.querySelectorAll(n.linksSelector||ye)):[]}function ee(l){return"/"+o+"/"+A(l)}function q(l){return h=l,this}function De(){return r}function ge(l,p,v){var y=s.find(function(z){return z.name===l}),b=null;if(y){if(b=y.path,p)for(var P in p)b=b.replace(":"+P,p[P]);b=b.match(/^\//)?b:"/"+b}return b&&v&&!v.includeRoot&&(b=b.replace(new RegExp("^/"+o),"")),b}function He(l){return l.getAttribute("href")}function _e(l){var p=Q(A(l)),v=p[0],y=p[1],b=y===""?null:le(y),P=J(l),z=C(v,function(){},[h],v);return{url:v,queryString:y,hashString:P,route:z,data:null,params:b}}function Ge(){return _e(A(Re(o)).replace(new RegExp("^"+o),""))}function Be(l){var p={instance:a,currentLocationPath:l,to:l,resolveOptions:n};return te(p,function(){}),p.matches?p.matches:!1}function Ve(l,p,v){typeof p<"u"&&(typeof v>"u"||v)&&(p=w(p));var y={instance:a,to:p,currentLocationPath:p};fe(y,function(){}),typeof l=="string"&&(l=typeof v>"u"||v?w(l):l);var b=Oe(y,{name:String(l),path:l,handler:function(){},hooks:{}});return b||!1}function W(l,p,v){return typeof p=="string"&&(p=me(p)),p?(p.hooks[l]||(p.hooks[l]=[]),p.hooks[l].push(v),function(){p.hooks[l]=p.hooks[l].filter(function(y){return y!==v})}):(console.warn("Route doesn't exists: "+p),function(){})}function me(l){return typeof l=="string"?s.find(function(p){return p.name===w(l)}):s.find(function(p){return p.handler===l})}function $e(l){l.instance.__dirty=!1,l.instance.__waiting.length>0&&l.instance.__waiting.shift()()}this.root=o,this.routes=s,this.destroyed=d,this.current=r,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=$e,this.on=x,this.off=T,this.resolve=u,this.navigate=_,this.navigateByName=f,this.destroy=R,this.notFound=U,this.updatePageLinks=k,this.link=ee,this.hooks=q,this.extractGETParameters=function(l){return Q(I(l))},this.lastResolved=De,this.generate=ge,this.getLinkPath=He,this.match=Be,this.matchLocation=Ve,this.getCurrentLocation=Ge,this.addBeforeHook=W.bind(this,"before"),this.addAfterHook=W.bind(this,"after"),this.addAlreadyHook=W.bind(this,"already"),this.addLeaveHook=W.bind(this,"leave"),this.getRoute=me,this._pathToMatchObject=_e,this._clean=A,this._checkForAHash=I,this._setCurrent=function(l){return r=a.current=l},N.call(this),k.call(this)}var vt=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function bt(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var Y={exports:{}},Et=Y.exports,Se;function yt(){return Se||(Se=1,(function(t,e){(function(n,a){var o={};n.PubSub?(o=n.PubSub,console.warn("PubSub already loaded, using existing version")):(n.PubSub=o,a(o)),t!==void 0&&t.exports&&(e=t.exports=o),e.PubSub=o,t.exports=e=o})(typeof window=="object"&&window||Et||vt,function(n){var a={},o=-1,r="*";function s(u){var _;for(_ in u)if(Object.prototype.hasOwnProperty.call(u,_))return!0;return!1}function d(u){return function(){throw u}}function h(u,_,f){try{u(_,f)}catch(T){setTimeout(d(T),0)}}function m(u,_,f){u(_,f)}function E(u,_,f,T){var N=a[_],R=T?m:h,U;if(Object.prototype.hasOwnProperty.call(a,_))for(U in N)Object.prototype.hasOwnProperty.call(N,U)&&R(N[U],u,f)}function I(u,_,f){return function(){var N=String(u),R=N.lastIndexOf(".");for(E(u,u,_,f);R!==-1;)N=N.substr(0,R),R=N.lastIndexOf("."),E(u,N,_,f);E(u,r,_,f)}}function w(u){var _=String(u),f=!!(Object.prototype.hasOwnProperty.call(a,_)&&s(a[_]));return f}function C(u){for(var _=String(u),f=w(_)||w(r),T=_.lastIndexOf(".");!f&&T!==-1;)_=_.substr(0,T),T=_.lastIndexOf("."),f=w(_);return f}function x(u,_,f,T){u=typeof u=="symbol"?u.toString():u;var N=I(u,_,T),R=C(u);return R?(f===!0?N():setTimeout(N,0),!0):!1}n.publish=function(u,_){return x(u,_,!1,n.immediateExceptions)},n.publishSync=function(u,_){return x(u,_,!0,n.immediateExceptions)},n.subscribe=function(u,_){if(typeof _!="function")return!1;u=typeof u=="symbol"?u.toString():u,Object.prototype.hasOwnProperty.call(a,u)||(a[u]={});var f="uid_"+String(++o);return a[u][f]=_,f},n.subscribeAll=function(u){return n.subscribe(r,u)},n.subscribeOnce=function(u,_){var f=n.subscribe(u,function(){n.unsubscribe(f),_.apply(this,arguments)});return n},n.clearAllSubscriptions=function(){a={}},n.clearSubscriptions=function(_){var f;for(f in a)Object.prototype.hasOwnProperty.call(a,f)&&f.indexOf(_)===0&&delete a[f]},n.countSubscriptions=function(_){var f,T,N=0;for(f in a)if(Object.prototype.hasOwnProperty.call(a,f)&&f.indexOf(_)===0){for(T in a[f])N++;break}return N},n.getSubscriptions=function(_){var f,T=[];for(f in a)Object.prototype.hasOwnProperty.call(a,f)&&f.indexOf(_)===0&&T.push(f);return T},n.unsubscribe=function(u){var _=function(ee){var q;for(q in a)if(Object.prototype.hasOwnProperty.call(a,q)&&q.indexOf(ee)===0)return!0;return!1},f=typeof u=="string"&&(Object.prototype.hasOwnProperty.call(a,u)||_(u)),T=!f&&typeof u=="string",N=typeof u=="function",R=!1,U,k,G;if(f){n.clearSubscriptions(u);return}for(U in a)if(Object.prototype.hasOwnProperty.call(a,U)){if(k=a[U],T&&k[u]){delete k[u],R=u;break}if(N)for(G in k)Object.prototype.hasOwnProperty.call(k,G)&&k[G]===u&&(delete k[G],R=!0)}return R}})})(Y,Y.exports)),Y.exports}var St=yt();const i=bt(St),c=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL"}),ae={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://streamsyncengage-saas.onrender.com"};var oe={};const S=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel"});function Ue(t,e=null){if(t in S)return S[t];if(typeof process<"u"&&oe&&oe[t]){const n=oe[t];return n==="true"?!0:n==="false"?!1:isNaN(n)?n:Number(n)}if(typeof import.meta<"u"&&ae&&ae[t]){const n=ae[t];return n==="true"?!0:n==="false"?!1:isNaN(n)?n:Number(n)}return e}function At(t){return Ue(t,!1)===!0}function wt(){return{...S}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:S,getFlag:Ue,isEnabled:At,getAllFlags:wt});function Tt(){console.log("[WebComponentBridge] Initializing global event bridge...");const t=e=>n=>{const a=n.detail?.pubsubTopic;a?(console.log(`[WebComponentBridge] ${e} -> ${a}:`,n.detail),i.publish(a,n.detail)):console.log(`[WebComponentBridge] ${e} (no topic):`,n.detail)};document.addEventListener("nav-select",t("nav-select")),document.addEventListener("logo-click",t("logo-click")),document.addEventListener("nav-hover",t("nav-hover")),document.addEventListener("nav-double-tap",t("nav-double-tap")),document.addEventListener("nav-long-tap",t("nav-long-tap")),document.addEventListener("message-sent",t("message-sent")),console.log("[WebComponentBridge] Global event bridge initialized")}function Nt(){console.log("[AppEvents] Initializing event listeners..."),i.subscribe(c.APP_READY,(n,a)=>{console.log("[AppEvents] APP_READY:",a)}),i.subscribe(c.APP_ERROR,(n,a)=>{console.error("[AppEvents] APP_ERROR:",a)}),i.subscribe(c.APP_SIGNOUT,(n,a)=>{console.log("[AppEvents] APP_SIGNOUT:",a)}),i.subscribe(c.ROUTE_NAV_BEFORE,(n,a)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",a),i.publish(c.UI_LOADING_START)}),i.subscribe(c.ROUTE_NAV_AFTER,(n,a)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",a),i.publish(c.UI_LOADING_END)}),i.subscribe(c.ROUTE_NAV_ERROR,(n,a)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",a),i.publish(c.APP_ERROR,{message:"Navigation error",details:a})}),i.subscribe(c.AUTH_SIGNIN_SUCCESS,(n,a)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",a)}),i.subscribe(c.AUTH_SIGNIN_FAIL,(n,a)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",a),i.publish(c.UI_TOAST,{message:a.message||"Sign in failed",type:"danger"})}),i.subscribe(c.AUTH_SIGNUP_SUCCESS,(n,a)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",a),i.publish(c.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),i.publish(c.AUTH_VERIFY_LINK)}),i.subscribe(c.AUTH_VERIFY_LINK,(n,a)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),i.subscribe(c.AUTH_SIGNUP_FAIL,(n,a)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",a),i.publish(c.UI_TOAST,{message:a.message||"Sign up failed",type:"danger"})}),i.subscribe(c.AUTH_SIGNOUT_SUCCESS,(n,a)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",a),i.publish(c.UI_TOAST,{message:"Signed out successfully",type:"info"})}),i.subscribe(c.AUTH_SIGNUP,(n,a)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),i.subscribe(c.AUTH_FORGOT,(n,a)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),i.subscribe(c.AUTH_FORGOT_SUCCESS,(n,a)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",a),i.publish(c.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),i.subscribe(c.AUTH_RESETHASH_NAV,(n,a)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),i.subscribe(c.AUTH_RESETHASH_SUCCESS,(n,a)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",a),i.publish(c.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),i.subscribe(c.AUTH_TOKEN_EXPIRED,(n,a)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",a),i.publish(c.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),i.subscribe(c.I18N_SET_LANG,(n,a)=>{console.log("[AppEvents] I18N_SET_LANG:",a);const{langCode:o}=a;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),i.publish(c.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(r){console.error("[AppEvents] Error changing language:",r),i.publish(c.UI_TOAST,{message:`Failed to change language: ${r.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),i.subscribe("CONVERSATION.PROMPT",(n,a)=>{const o=n.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,a),!a||!a.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",a.message),re(a.message,"user",a.timestamp),i.publish(c.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Send prompt to agent:",a.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Send prompt to agent + canvas:",a.message),re(a.message,"user",a.timestamp),i.publish(c.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",a.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),i.subscribe("CONVERSATION.RESPONSE",(n,a)=>{const o=n.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,a),!a||!a.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",a.message),re(a.message,"assistant",a.timestamp);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",a.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),i.subscribe(c.UI_LOADING_START,(n,a)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),i.subscribe(c.UI_LOADING_END,(n,a)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),i.subscribe(c.UI_TOAST,(n,a)=>{console.log("[AppEvents] UI_TOAST:",a)}),i.subscribe(c.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const n="0.1",a=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${n} 5/24/2026, 9:10:39 PM|© ${a} Mach Five Tech`,"night")}),Tt(),i.subscribe("M5T_PRIMARY_NAV",(n,a)=>{const o=n.split(".")[1];switch(console.log(`[AppEvents] M5T_PRIMARY_NAV.${o}:`,a),o){case"TAP":t(a);break;case"LOGO_TAP":e();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function t(n){const{token:a,level:o,primaryToken:r}=n;switch(a){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),i.publish(c.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${a}`,{primaryToken:r});break}}function e(n){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 5/24/2026, 9:10:39 PM|© ${o} Mach Five Tech`,"night",5e3)}i.subscribe(c.AUTH_SIGNOUT,(n,a)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(S.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function re(t,e="user",n=null){const a=document.getElementById("chat-messages");if(!a){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}n||(n=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}));let o;e==="user"||e==="prompt"?o=document.createElement("m5t-chat-prompt"):o=document.createElement("m5t-chat-response"),o.setAttribute("message",t),o.setAttribute("timestamp",n),a.prepend(o),console.log(`[AppEvents] Added ${e} bubble to canvas:`,t)}class F{static CONFIG={BASE_URL:window.location.hostname==="localhost"?"http://localhost:3333":"https://streamsyncengage-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#n=null;static#a=null;static#s=null;static async init({BASE_URL:e,navigateFunction:n,customConfig:a={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(n&&typeof n=="function")this.#s=n;else throw new Error("navigateFunction is required and must be a function");return e&&(this.CONFIG.BASE_URL=e),a&&Object.keys(a).length>0&&(this.CONFIG={...this.CONFIG,...a}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#c(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#d(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#l(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((e=null)=>{e&&(console.log("[AuthController] mvvLegit navigation to:",e),this.#o(e))}).setOnState((e=null)=>{if(e)switch(console.log("[AuthController] Auth state changed:",e),e){case"AUTH":case 4:this.#g();break;case"UNAUTH":case 1:this.#_();break;case"UNVERF":case 2:this.#m();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#o(e){if(!this.#s){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",e);const n=e.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",n),this.#s(n)}static#c(){try{const e=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);e&&(this.#n=JSON.parse(e),console.log("[AuthController] Entity state loaded:",this.#n?.email))}catch(e){console.error("[AuthController] Error loading entity state:",e),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#n=null}this.#a=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null}static#r(e){try{this.#n=e,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(e)),console.log("[AuthController] Entity state saved")}catch(n){console.error("[AuthController] Error saving entity state:",n)}}static#i(){this.#n=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY)}static getEntity(){return this.#n}static async doSignin(e,n){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,hash:n})}),o=await a.json();return a.status===303?(console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#r(o.entity)),setTimeout(()=>{this.#o(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o}):a.ok&&o.accessToken?(console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#r(o.entity),console.log("[AuthController] Explicitly navigating to home"),this.#o(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}):{ok:!1,error:o.error||"Sign in failed",data:o}}catch(a){return console.error("[AuthController] Signin error:",a),{ok:!1,error:a.message}}}static async doSignout(e=!1){console.log("[AuthController] doSignout called, serverInitiated:",e);try{const n=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!n),!e&&n){const a=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(n)}`;if(console.log("[AuthController] Sending signout beacon to:",a),navigator.sendBeacon){const o=navigator.sendBeacon(a);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else n||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#i(),console.log("[AuthController] Stopping auth ping..."),this.#u(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(n){console.error("[AuthController] Signout error:",n),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(e){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),a=await n.json();return n.ok&&a.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#r(a.entity),{ok:!0,data:a}):{ok:!1,error:a.error||"Sign up failed",data:a}}catch(n){return console.error("[AuthController] Signup error:",n),{ok:!1,error:n.message}}}static async doResetHash(e,n){try{const a=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${a}`,"Content-Type":"application/json"},body:JSON.stringify({email:e,hash:n,modified_by:e})}),r=await o.json();return o.ok&&r.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:r}):{ok:!1,error:r.error||"Password reset failed",data:r}}catch(a){return console.error("[AuthController] Reset password error:",a),{ok:!1,error:a.message}}}static#d(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#p()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#u(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#p(){try{const e=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);e.ok?console.log("[AuthController] Ping success"):(e.status===401||e.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(e){console.error("[AuthController] Ping error:",e)}}static setDeepLinkGuid(e){this.#a=e,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,e),console.log("[AuthController] Deep-link GUID stored:",e)}static getDeepLinkGuid(){return this.#a}static clearDeepLink(){this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#g(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#d()}static#_(){console.log("[AuthController] User unauthenticated"),this.#u()}static#m(){console.log("[AuthController] User unverified")}static getAuthState(){try{const e=mvvLegit.getConf()?.LSKEY||"mvv",n=localStorage.getItem(e);if(!n)return"UNAUTH";if(typeof LZString>"u")return null;const a=LZString.decompressFromUTF16(n),r=JSON.parse(a)?.state;return r===1?"UNAUTH":r===2?"UNVERF":r===4?"AUTH":r===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(e){this.#o(e)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#p()}}class g{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:e,product:n,whitelabel:a,lang:o}){e&&(this.#t.buildMode=e),n&&(this.#t.product=n),a&&(this.#t.whitelabel=a),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(e,n={}){const a={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:d}=a;try{const h=this.#e[o]?.[r]?.[s]?.[d]?.[e];return h?Array.isArray(h)?h[Math.floor(Math.random()*h.length)]:h:(console.warn(`[MicrocopyManager] Token not found: ${e} (${o}/${r}/${s}/${d})`),null)}catch(h){return console.error(`[MicrocopyManager] Error retrieving token: ${e}`,h),null}}static getAll(e={}){const n={...this.#t,...e},{buildMode:a,product:o,whitelabel:r,lang:s}=n;try{return this.#e[a]?.[o]?.[r]?.[s]||null}catch(d){return console.error("[MicrocopyManager] Error retrieving all tokens",d),null}}static has(e,n={}){const a={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:d}=a;try{return!!this.#e[o]?.[r]?.[s]?.[d]?.[e]}catch{return!1}}static getAvailableLanguages(){const{buildMode:e,product:n,whitelabel:a}=this.#t;try{return Object.keys(this.#e[e]?.[n]?.[a]||{})}catch{return[]}}static update(e,n,a={}){const o={...this.#t,...a},{buildMode:r,product:s,whitelabel:d,lang:h}=o;try{return this.#e[r]||(this.#e[r]={}),this.#e[r][s]||(this.#e[r][s]={}),this.#e[r][s][d]||(this.#e[r][s][d]={}),this.#e[r][s][d][h]||(this.#e[r][s][d][h]={}),this.#e[r][s][d][h][e]=n,!0}catch(m){return console.error(`[MicrocopyManager] Error updating token: ${e}`,m),!1}}static delete(e,n={}){const a={...this.#t,...n},{buildMode:o,product:r,whitelabel:s,lang:d}=a;try{return delete this.#e[o]?.[r]?.[s]?.[d]?.[e],!0}catch(h){return console.error(`[MicrocopyManager] Error deleting token: ${e}`,h),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(e){try{return this.#e=e,!0}catch(n){return console.error("[MicrocopyManager] Error importing data",n),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:g});class D{static#e=!1;static#t=null;static#n=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const e=this.#s();g.setContext(e),console.log("[I18nController] Initialized with context:",e),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#l(),this.#c(),this.#e=!0,this.refresh()}static#a(e){const n={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},a=e.toLowerCase();return n[a]||"DEV"}static#s(){const n=this.#a("production"),a=localStorage.getItem(S.FF_SSE_LS_WHITELABEL)||S.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(S.FF_SSE_LS_USER_LANG)||S.FF_SSE_I18N_LANG;return{buildMode:n,product:S.FF_SSE_I18N_PRODUCT,whitelabel:a,lang:o}}static#l(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((e,n,a)=>{S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",a),this.#t=a,setTimeout(()=>{this.refresh()},S.FF_SSE_I18N_APPLY_DELAY_MS)},S.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#o())}static#o(){setInterval(()=>{const n=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");n&&n!==this.#t&&(this.#t=n,this.refresh())},500)}static#c(){this.#n||(this.#n=new MutationObserver(e=>{let n=!1;for(const a of e){for(const o of a.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){n=!0;break}if(n)break}n&&(S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#n.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#i(document.body),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(e){const n=e.querySelectorAll("[data-meta-copywrite-i118n]");S.FF_SSE_I18N_DEBUG&&n.length>0&&console.log(`[I18nController] Processing ${n.length} elements`),n.forEach(a=>{try{const o=a.getAttribute("data-meta-copywrite-i118n"),r=JSON.parse(o);if(!r.token){console.warn("[I18nController] Missing token in config:",r);return}const s=r.attribute||"textContent",d=g.get(r.token);if(d===null){console.warn(`[I18nController] Microcopy not found for token: ${r.token}`);return}s==="textContent"?a.textContent=d:s==="innerHTML"?a.innerHTML=d:a.setAttribute(s,d),S.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${d}" to ${s} for token: ${r.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,a)}})}static#i(e){e.querySelectorAll("*").forEach(a=>{a.shadowRoot&&(this.#r(a.shadowRoot),this.#i(a.shadowRoot))})}static setLanguage(e){const n=g.getAvailableLanguages();if(!n.includes(e)){console.error(`[I18nController] Language not available: ${e}. Available:`,n);return}localStorage.setItem(S.FF_SSE_LS_USER_LANG,e),g.setContext({lang:e}),console.log("[I18nController] Language changed to:",e);const a=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:e}});document.dispatchEvent(a),this.refresh()}static setWhitelabel(e){localStorage.setItem(S.FF_SSE_LS_WHITELABEL,e),g.setContext({whitelabel:e}),S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",e),this.refresh()}static getLanguage(){return g.getContext().lang}static getAvailableLanguages(){return g.getAvailableLanguages()}static getContext(){return g.getContext()}static destroy(){this.#n&&(this.#n.disconnect(),this.#n=null),this.#e=!1,this.#t=null,S.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{D.initialize()}):D.initialize());window.m5t=Object.create(null);window.m5t.pubsub=i;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(t){console.log("mvvLegit (direct): ReferenceError -",t.message)}const It=Object.keys(window).filter(t=>t.toLowerCase().includes("mvv")||t.toLowerCase().includes("neodigm")||t.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",It);const O=new ft("/",{hash:!0});window.router=O;function de(t){const e=t?`${t.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${t} -> ${e}`),mvvLegit.isRouteAllowed(e)?!0:(console.warn(`[Router] Access denied to route: ${e}`),i.publish(c.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function $(t){console.log("[Router] Navigating to:",t),O.navigate(`/${t}`)}O.on("/",()=>{console.log("[Router] Route: /"),i.publish(c.ROUTE_NAV_BEFORE,{route:"splash"}),M(()=>Promise.resolve().then(()=>Fe),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"splash"})}).catch(t=>{console.error("[Router] Error loading splash route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"splash",error:t})})});O.on("/splash",()=>{console.log("[Router] Route: /splash"),i.publish(c.ROUTE_NAV_BEFORE,{route:"splash"}),M(()=>Promise.resolve().then(()=>Fe),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"splash"})}).catch(t=>{console.error("[Router] Error loading splash route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"splash",error:t})})});O.on("/signin",()=>{console.log("[Router] Route: /signin"),i.publish(c.ROUTE_NAV_BEFORE,{route:"signin"}),M(()=>Promise.resolve().then(()=>Mt),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"signin"})}).catch(t=>{console.error("[Router] Error loading signin route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"signin",error:t})})});O.on("/signup",()=>{console.log("[Router] Route: /signup"),i.publish(c.ROUTE_NAV_BEFORE,{route:"signup"}),M(()=>Promise.resolve().then(()=>Vt),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"signup"})}).catch(t=>{console.error("[Router] Error loading signup route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"signup",error:t})})});O.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),i.publish(c.ROUTE_NAV_BEFORE,{route:"verf-link"}),M(()=>Promise.resolve().then(()=>zt),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(t=>{console.error("[Router] Error loading verf-link route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"verf-link",error:t})})});O.on("/forgot",()=>{console.log("[Router] Route: /forgot"),i.publish(c.ROUTE_NAV_BEFORE,{route:"forgot"}),M(()=>Promise.resolve().then(()=>Zt),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(t=>{console.error("[Router] Error loading forgot route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"forgot",error:t})})});O.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!de("resethash")){$("signin");return}i.publish(c.ROUTE_NAV_BEFORE,{route:"resethash"}),M(()=>Promise.resolve().then(()=>nn),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(t=>{console.error("[Router] Error loading resethash route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"resethash",error:t})})});O.on("/home",()=>{if(console.log("[Router] Route: /home"),!de("home")){$("signin");return}i.publish(c.ROUTE_NAV_BEFORE,{route:"home"}),M(()=>Promise.resolve().then(()=>mn),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"home"})}).catch(t=>{console.error("[Router] Error loading home route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"home",error:t})})});O.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!de("signout")){$("signin");return}i.publish(c.ROUTE_NAV_BEFORE,{route:"signout"}),M(()=>Promise.resolve().then(()=>vn),void 0).then(t=>{const e=document.getElementById("app");e.innerHTML=t.render(),t.init&&t.init(),i.publish(c.ROUTE_NAV_AFTER,{route:"signout"})}).catch(t=>{console.error("[Router] Error loading signout route:",t),i.publish(c.ROUTE_NAV_ERROR,{route:"signout",error:t})})});O.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),$("splash")});i.subscribe(c.ROUTE_NAV,(t,e)=>{console.log("[Router] ROUTE_NAV event received:",e),e?.route&&$(e.route)});function Ae(){console.log("[App] Waiting for Neodigm 55 library...");let t=0;const e=100,n=setInterval(()=>{t++,t%10===0&&console.log(`[App] Still waiting... attempt ${t}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${t*100}ms`),clearInterval(n),Rt()):t>=e&&(clearInterval(n),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,i.publish(c.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ae):Ae();async function Rt(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Nt(),D.initialize(),console.log("[App] I18n Controller initialized"),!await F.init({BASE_URL:"https://streamsyncengage-saas.onrender.com",navigateFunction:n=>{console.log("[AuthController] Navigation requested:",n),$(n)}})){console.error("[App] AuthController initialization failed");return}const e=F.getEntity();e&&(console.log("[App] Session restored for:",e.email),i.publish(c.APP_USER_LOADED,{entity:e})),i.publish(c.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),O.resolve(),window.AuthController=F,window.I18nController=D,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController available globally)")}i.subscribe(c.ROUTE_NAV_AFTER,(t,e)=>{typeof D<"u"&&D.refresh&&setTimeout(()=>{D.refresh()},100)});function Ot(){return`
  ...
  `}function Ct(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const t=localStorage.getItem(S.FF_SSE_LS_TOKEN),e=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!t,hasMvvTs:!!e});const n=document.getElementById("splash-loader"),a=document.getElementById("splash-actions");t?(console.log("[SplashRoute] Auth token found → HOME"),i.publish(c.ROUTE_NAV,{route:"home"})):e?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),i.publish(c.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),n&&(n.style.display="none"),a&&(a.style.display="flex"),document.querySelectorAll("[data-route]").forEach(r=>{r.addEventListener("click",()=>{const s=r.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${s}`),i.publish(c.ROUTE_NAV,{route:s})})}))},4e3)}const Fe=Object.freeze(Object.defineProperty({__proto__:null,init:Ct,render:Ot},Symbol.toStringTag,{value:"Module"}));function ue(t){return t=String(t),Math.abs(t.split("").reduce((e,n)=>(e<<5)-e+n.charCodeAt(0)|0,0))}function kt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Pt(){console.log("[SigninRoute] Initialized");const t=document.getElementById("loginForm"),e=document.getElementById("email"),n=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const r=n.type==="password"?"text":"password";n.type=r}),t?.addEventListener("submit",async r=>{r.preventDefault();const s=e.value.trim(),d=n.value;Lt(s,e)&&Ut(d,n)&&await Ft(s,d)}),document.getElementById("link--uc__underline")?.addEventListener("click",r=>{r.preventDefault(),i.publish(c.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",r=>{r.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),i.publish(c.ROUTE_NAV,{route:"signup"})})}function Lt(t,e){if(!t)return X(e,g.get("validation_email_required")),!1;const n=(t.match(/@/g)||[]).length,a=(t.match(/\./g)||[]).length;return n!==1||a<1?(X(e,g.get("validation_email_invalid")),!1):!0}function Ut(t,e){return t?t.length<10?(X(e,g.get("validation_password_min_length")),!1):!0:(X(e,g.get("validation_password_required")),!1)}function X(t,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${t.id}`):(t.classList.add("shake"),setTimeout(()=>t.classList.remove("shake"),300)),t.focus()}async function Ft(t,e){const n=document.querySelector(".btn");n.disabled=!0,n.textContent=g.get("loading_signing_in");try{const a=ue(e),o=await F.doSignin(t,a);o.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(g.get("success_welcome_back"),"success"),i.publish(c.AUTH_SIGNIN_SUCCESS,{entity:F.getEntity()})):o.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(g.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(o.error||g.get("error_signin_failed"),"danger"),n.disabled=!1,n.textContent=g.get("sign_in").toUpperCase())}catch(a){console.error("[SigninRoute] Sign in error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||g.get("error_network"),"danger"),n.disabled=!1,n.textContent=g.get("sign_in").toUpperCase(),i.publish(c.AUTH_SIGNIN_FAIL,{message:a.message})}}const Mt=Object.freeze(Object.defineProperty({__proto__:null,init:Pt,render:kt},Symbol.toStringTag,{value:"Module"}));function Me(t){const e=[];return t.length<10&&e.push("at least 10 characters"),/[a-z]/.test(t)||e.push("1 lowercase"),/[A-Z]/.test(t)||e.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(t)||e.push("1 special character"),/[^\x00-\x7F]/.test(t)&&e.push("ASCII characters only"),e}function xe(t){return t.length===0?"":t.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":t.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}function xt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Dt(){console.log("[SignupRoute] Initialized");const t=document.getElementById("signupForm"),e=t.querySelector('button[type="submit"]');we("togglePassword","password","eyeIcon"),we("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",a=>{a.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),i.publish(c.ROUTE_NAV,{route:"signin"})}),t.addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("first").value.trim(),r=document.getElementById("last").value.trim(),s=document.getElementById("email").value.trim(),d=document.getElementById("company").value.trim(),h=document.getElementById("phone").value.trim(),m=document.getElementById("password").value,E=document.getElementById("confirmPassword").value,I=document.getElementById("first"),w=document.getElementById("last"),C=document.getElementById("email"),x=document.getElementById("password"),u=document.getElementById("confirmPassword");if(Te(o,I,g.get("validation_first_name_required"))&&Te(r,w,g.get("validation_last_name_required"))&&Ht(s,C)&&Gt(m,x)){if(m!==E){V(u,g.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=g.get("loading_creating_account"),await Bt(o,r,s,d,h,m)}})}function we(t,e,n){const a=document.getElementById(t),o=document.getElementById(e),r=document.getElementById(n);!a||!o||!r||a.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Te(t,e,n){return t?!0:(V(e,n),!1)}function Ht(t,e){if(!t)return V(e,g.get("validation_email_required")),!1;const n=(t.match(/@/g)||[]).length,a=(t.match(/\./g)||[]).length;return n!==1||a<1?(V(e,g.get("validation_email_invalid")),!1):!0}function Gt(t,e){if(!t)return V(e,g.get("validation_password_required")),!1;const n=Me(t);return n.length>0?(V(e,xe(n)),!1):!0}function V(t,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${t.id}`):(t.classList.add("shake"),setTimeout(()=>t.classList.remove("shake"),300)),t.focus()}async function Bt(t,e,n,a,o,r){const s=document.querySelector('button[type="submit"]');try{const d=ue(r),h={email:n,hash:d,first:t,last:e};a&&(h.company=a),o&&(h.phone=o);const m=await F.doSignup(h);if(m.ok)i.publish(c.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const E=m.error||m.message||g.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(E,"danger"),s.disabled=!1,s.textContent=g.get("create_account").toUpperCase(),i.publish(c.AUTH_SIGNUP_FAIL,{message:E})}}catch(d){console.error("[SignupRoute] Sign up error:",d),typeof neodigmToast<"u"&&neodigmToast.q(d.message||g.get("error_network"),"danger"),s.disabled=!1,s.textContent=g.get("create_account").toUpperCase(),i.publish(c.AUTH_SIGNUP_FAIL,{message:d.message})}}const Vt=Object.freeze(Object.defineProperty({__proto__:null,init:Dt,render:xt},Symbol.toStringTag,{value:"Module"}));function $t(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function qt(){console.log("[VerfLinkRoute] Initialized");const t=7200,e=Date.now(),n=document.getElementById("countdown-display");function a(){const r=Date.now()-e,s=Math.floor(r/1e3),d=Math.max(0,t-s),h=Math.floor(d/3600),m=Math.floor(d%3600/60),E=d%60,I=`${String(h).padStart(2,"0")}:${String(m).padStart(2,"0")}:${String(E).padStart(2,"0")}`;n&&(n.textContent=I,d<600&&(n.style.color="#ef4444",n.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),d===0&&(n.style.color="#7f1d1d",n.style.textShadow="none")),d===0&&(clearInterval(o),console.log("[VerfLinkRoute] Countdown expired"),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate("/splash")},600))}a();const o=setInterval(a,1e3);window.addEventListener("beforeunload",()=>{clearInterval(o)})}const zt=Object.freeze(Object.defineProperty({__proto__:null,init:qt,render:$t},Symbol.toStringTag,{value:"Module"})),Yt="https://streamsyncengage-saas.onrender.com";class jt{constructor(){this.baseUrl=Yt}async request(e,n={}){const a=`${this.baseUrl}${e}`,o={"Content-Type":"application/json",...n.headers};try{const r=await fetch(a,{...n,headers:o});if(r.status===401||r.status===403){i.publish(c.AUTH_TOKEN_EXPIRED,{status:r.status,endpoint:e});const d=await r.json().catch(()=>({}));throw new Error(d.error||"Authentication failed")}const s=await r.json();return{ok:r.ok,status:r.status,data:s}}catch(r){throw console.error("API Request Error:",r),i.publish(c.APP_ERROR,{message:r.message,endpoint:e}),r}}async get(e){return this.request(e,{method:"GET"})}async post(e,n){return this.request(e,{method:"POST",body:JSON.stringify(n)})}async put(e,n){return this.request(e,{method:"PUT",body:JSON.stringify(n)})}async delete(e){return this.request(e,{method:"DELETE"})}async signin(e,n){return this.post("/api/acctEntity/signin",{email:e,hash:n})}async signup(e){return this.post("/api/acctEntity/signup",e)}async signout(){return this.post("/api/acctEntity/signout",{})}async forgotPassword(e){return this.post("/api/acctEntity/forgot",{email:e})}async resetHash(e,n){return this.post("/api/acctEntity/resethash",{email:e,hash:n})}async verifyAccount(e){return this.get(`/api/acctEntity/verify?CODE=${e}`)}async getAccounts(){return this.get("/api/acctEntity")}async getAccount(e){return this.get(`/api/acctEntity/${e}`)}async updateAccount(e,n){return this.put(`/api/acctEntity/${e}`,n)}async deleteAccount(e){return this.delete(`/api/acctEntity/${e}`)}async ping(){return this.get("/ping")}}const Wt=new jt;function Kt(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Jt(){console.log("[ForgotRoute] Initialized");const t=document.getElementById("forgot-form"),e=document.getElementById("email");t?.addEventListener("submit",async n=>{n.preventDefault();const a=e.value.trim();Qt(a,e)&&await Xt(a)})}function Qt(t,e){if(!t)return Ne(e,g.get("validation_email_required")),!1;const n=(t.match(/@/g)||[]).length,a=(t.match(/\./g)||[]).length;return n!==1||a<1?(Ne(e,g.get("validation_email_invalid")),!1):!0}function Ne(t,e){typeof neodigmToast<"u"&&neodigmToast.q(e,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${t.id}`):(t.classList.add("shake"),setTimeout(()=>t.classList.remove("shake"),300)),t.focus()}async function Xt(t){const e=document.querySelector(".btn");e.disabled=!0,e.textContent="SENDING...";try{const n=await Wt.forgotPassword(t);n.ok&&n.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(g.get("success_reset_link_sent"),"success"),i.publish(c.AUTH_FORGOT_SUCCESS,{email:t}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(n.data.error||g.get("error_signin_failed"),"danger"),e.disabled=!1,e.textContent=g.get("send_reset_link").toUpperCase())}catch(n){console.error("[ForgotRoute] Forgot password error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||g.get("error_network"),"danger"),e.disabled=!1,e.textContent=g.get("send_reset_link").toUpperCase()}}const Zt=Object.freeze(Object.defineProperty({__proto__:null,init:Jt,render:Kt},Symbol.toStringTag,{value:"Module"}));function en(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function tn(){console.log("[ResethashRoute] Initialized");const t=document.getElementById("resethash-form"),e=t.querySelector('button[type="submit"]');Ie("toggleNewPassword","new-password","eyeIconNew"),Ie("toggleConfirmPassword","confirm-password","eyeIconConfirm"),t?.addEventListener("submit",async n=>{n.preventDefault();const a=t.email.value.trim(),o=t.newPassword.value,r=t.confirmPassword.value,s=document.getElementById("new-password"),d=document.getElementById("confirm-password");if(!o){B(s,g.get("validation_new_password_required"));return}const h=Me(o);if(h.length>0){B(s,xe(h));return}if(!r){B(d,g.get("validation_new_password_required"));return}if(o!==r){B(d,g.get("validation_password_mismatch"));return}e.disabled=!0,e.textContent=g.get("loading_resetting_password");try{const m=ue(o),E=await F.doResetHash(a,m);E.ok?(typeof neodigmToast<"u"&&neodigmToast.q(g.get("success_password_reset"),"success"),i.publish(c.AUTH_RESETHASH_SUCCESS,{email:a})):(B(s,E.error||g.get("error_signin_failed")),e.disabled=!1,e.textContent=g.get("update_password").toUpperCase())}catch(m){console.error("[ResethashRoute] Reset password error:",m),B(s,m.message||g.get("error_network")),e.disabled=!1,e.textContent=g.get("update_password").toUpperCase()}})}function Ie(t,e,n){const a=document.getElementById(t),o=document.getElementById(e),r=document.getElementById(n);!a||!o||!r||a.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
    ...
    `}renderButton(e,n,a="primary"){const o=a==="primary"?e.token===this.selectedPrimaryToken:!1,r=typeof e.count=="number"&&e.count!==null&&e.count!==void 0,s=e.icon&&e.icon.trim()!=="",d=e.tagline&&e.tagline.trim()!=="";return`
      <button
    ...
    `}}customElements.define("m5t-chat-prompt",on);class rn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}static get observedAttributes(){return["message","timestamp","show-timestamp","avatar","show-avatar"]}attributeChangedCallback(e,n,a){n!==a&&this.render()}getMessage(){return this.getAttribute("message")||""}getTimestamp(){const e=this.getAttribute("timestamp");return e||new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}shouldShowTimestamp(){return this.getAttribute("show-timestamp")!=="false"}getAvatar(){return this.getAttribute("avatar")||""}shouldShowAvatar(){return this.getAttribute("show-avatar")==="true"&&this.getAvatar()}escapeHtml(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}render(){const e=this.getMessage(),n=this.getTimestamp(),a=this.shouldShowTimestamp(),o=this.getAvatar(),r=this.shouldShowAvatar();this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: flex;
          flex-direction: column;
    ...
    `}}customElements.define("m5t-chat-response",rn);class sn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.attachEventListeners()}getPlaceholder(){return this.getAttribute("placeholder")||"Type your message..."}getMaxRows(){return parseInt(this.getAttribute("max-rows"))||5}render(){const e=this.getPlaceholder(),n=this.getMaxRows();this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    <div class="home-container">
      ...
      <main class="home-main" id="chat-canvas">
        ...
        <div class="chat-messages" id="chat-messages">
          ...
          <m5t-chat-response
            message="Hi there! This is an assistant response. How can I help you today?"
            timestamp="10:32 AM">
          </m5t-chat-response>
  ...
  `}function cn(){console.log("[HomeRoute] Initialized"),i.subscribe(c.CANVAS_DO_SCROLL,(t,e)=>{console.log("[HomeRoute] CANVAS.DO.SCROLL triggered"),dn()})}function dn(){setTimeout(()=>{const t=document.getElementById("chat-messages");t?(t.scrollTo({top:0,behavior:"smooth"}),console.log("[HomeRoute] Scrolled chat-messages to bottom (top: 0 with column-reverse)")):console.warn("[HomeRoute] chat-messages element not found")},80)}function pe(t,e="user",n="canvas"){const a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),o={message:t,timestamp:a};if(e==="user"||e==="prompt")switch(n.toUpperCase()){case"CANVAS":i.publish(c.CONVERSATION_PROMPT_CANVAS,o);break;case"AGENT":i.publish(c.CONVERSATION_PROMPT_AGENT,o);break;case"AGENT_CANVAS":i.publish(c.CONVERSATION_PROMPT_AGENT_CANVAS,o);break;case"STAGE":i.publish(c.CONVERSATION_PROMPT_STAGE,o);break;default:i.publish(c.CONVERSATION_PROMPT_CANVAS,o)}else switch(n.toUpperCase()){case"CANVAS":i.publish(c.CONVERSATION_RESPONSE_CANVAS,o);break;case"WORKFLOW":i.publish(c.CONVERSATION_RESPONSE_WORKFLOW,o);break;default:i.publish(c.CONVERSATION_RESPONSE_CANVAS,o)}}function un(t=10,e=500){const n=["Hey, how's it going?","Can you help me with something?","What's the weather like today?","I need assistance with my account","Tell me a joke!","How do I reset my password?","What are your hours?","Thanks for your help!","I have a question about billing","Can you explain this feature?","How do I upgrade my plan?","What's new in the latest update?","I'm having trouble logging in","Where can I find the settings?","How secure is my data?","Do you offer customer support?","What payment methods do you accept?","Can I cancel my subscription?","How do I export my data?","Is there a mobile app?"],a=["I'm doing great! How can I help you today?","Of course! I'd be happy to assist you.","Let me check that for you...","Here's what I found:","That's a great question!","I can help you with that.","Let me walk you through the steps.","You're very welcome!","I understand your concern. Let me explain...","That feature is located in the settings menu.","Your account is fully secured with encryption.","We're available 24/7 to help you!","We accept all major credit cards and PayPal.","You can upgrade anytime from your account settings.","The latest update includes several new features!","Try resetting your password using the forgot password link.","Your data is encrypted and stored securely.","Yes! Our mobile app is available for iOS and Android.","You can export your data from the account settings.","Absolutely! You can cancel anytime with no fees."];let o=0;const r=setInterval(()=>{if(o>=t){clearInterval(r),console.log(`[Test] Generated ${t} random bubbles`);return}const s=Math.random()>.5,d=s?"user":"assistant",h=s?n:a,m=h[Math.floor(Math.random()*h.length)];pe(m,d),o++,console.log(`[Test] Added bubble ${o}/${t} (${d})`)},e)}let j=null;function pn(t=1e3){if(j){console.log("[Test] Bubble stream already running. Stop it first with stopBubbleStream()");return}console.log("[Test] Starting continuous bubble stream..."),j=setInterval(()=>{const e=Math.random()>.5,n=e?["Quick message!","Another one!","Test bubble","Hello there!","Random user text"]:["Response here","Got it!","Processing...","Here's the answer","Understood!"],a=n[Math.floor(Math.random()*n.length)];pe(a,e?"user":"assistant")},t)}function gn(){j?(clearInterval(j),j=null,console.log("[Test] Bubble stream stopped")):console.log("[Test] No bubble stream running")}function _n(){const t=document.getElementById("chat-messages");t&&(t.innerHTML="",console.log("[Test] All bubbles cleared"))}window.addChatBubble=pe;window.generateRandomBubbles=un;window.startBubbleStream=pn;window.stopBubbleStream=gn;window.clearAllBubbles=_n;console.log("[HomeRoute] Test functions available:");console.log("  - window.generateRandomBubbles(count, delay) - Generate N bubbles with delay");console.log("  - window.startBubbleStream(delayMs) - Continuous bubble generation");console.log("  - window.stopBubbleStream() - Stop continuous generation");console.log("  - window.clearAllBubbles() - Remove all bubbles");console.log("  - window.addChatBubble(message, type) - Add single bubble");const mn=Object.freeze(Object.defineProperty({__proto__:null,init:cn,render:ln},Symbol.toStringTag,{value:"Module"}));function hn(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function fn(){console.log("[SignoutRoute] Initialized");const t=document.getElementById("confirm-signout-btn");t?.addEventListener("click",async()=>{t.disabled=!0,t.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await F.doSignout()})}const vn=Object.freeze(Object.defineProperty({__proto__:null,init:fn,render:hn},Symbol.toStringTag,{value:"Module"}));
